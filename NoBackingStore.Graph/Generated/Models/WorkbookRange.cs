...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class WorkbookRange : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.WorkbookRangeFormat? Format { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.WorkbookRangeFormat Format { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.WorkbookRangeSort? Sort { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.WorkbookRangeSort Sort { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.WorkbookRange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.WorkbookRange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.WorkbookRange();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "format", n => { Format = n.GetObjectValue<global::NoBackingStore.Graph.Models.WorkbookRangeFormat>(global::NoBackingStore.Graph.Models.WorkbookRangeFormat.CreateFromDiscriminatorValue); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::NoBackingStore.Graph.Models.WorkbookRangeSort>(global::NoBackingStore.Graph.Models.WorkbookRangeSort.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.WorkbookRangeFormat>("format", Format);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.WorkbookRangeSort>("sort", Sort);
