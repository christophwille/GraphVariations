...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CompanySubscription : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ServicePlanInfo>? ServiceStatus { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ServicePlanInfo> ServiceStatus { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CompanySubscription"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CompanySubscription CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CompanySubscription();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "serviceStatus", n => { ServiceStatus = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ServicePlanInfo>(global::NoBackingStore.Graph.Models.ServicePlanInfo.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ServicePlanInfo>("serviceStatus", ServiceStatus);
