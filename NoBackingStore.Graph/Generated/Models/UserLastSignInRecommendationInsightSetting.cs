...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UserLastSignInRecommendationInsightSetting : global::NoBackingStore.Graph.Models.AccessReviewRecommendationInsightSetting, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.UserSignInRecommendationScope? SignInScope { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.UserLastSignInRecommendationInsightSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UserLastSignInRecommendationInsightSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.UserLastSignInRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UserLastSignInRecommendationInsightSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "signInScope", n => { SignInScope = n.GetEnumValue<global::NoBackingStore.Graph.Models.UserSignInRecommendationScope>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.UserSignInRecommendationScope>("signInScope", SignInScope);
        }
    }
}
