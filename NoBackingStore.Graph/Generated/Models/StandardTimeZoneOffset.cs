...
namespace NoBackingStore.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.DayOfWeekObject? DayOfWeek { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.StandardTimeZoneOffset"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.StandardTimeZoneOffset"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.StandardTimeZoneOffset CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("@odata.type")?.GetStringValue();
            return mappingValue switch
            {
                "#microsoft.graph.daylightTimeZoneOffset" => new global::NoBackingStore.Graph.Models.DaylightTimeZoneOffset(),
                _ => new global::NoBackingStore.Graph.Models.StandardTimeZoneOffset(),
            };
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "dayOfWeek", n => { DayOfWeek = n.GetEnumValue<global::NoBackingStore.Graph.Models.DayOfWeekObject>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DayOfWeekObject>("dayOfWeek", DayOfWeek);
