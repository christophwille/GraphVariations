...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class ProtectionRuleBase : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.ProtectionRuleStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ProtectionRuleBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.ProtectionRuleBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::NoBackingStore.Graph.Models.ProtectionRuleBase(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.ProtectionRuleStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ProtectionRuleStatus>("status", Status);
        }
    }
}
