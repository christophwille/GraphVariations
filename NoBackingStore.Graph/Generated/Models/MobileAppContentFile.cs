...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class MobileAppContentFile : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.MobileAppContentFileUploadState? UploadState { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MobileAppContentFile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.MobileAppContentFile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MobileAppContentFile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "uploadState", n => { UploadState = n.GetEnumValue<global::NoBackingStore.Graph.Models.MobileAppContentFileUploadState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MobileAppContentFileUploadState>("uploadState", UploadState);
        }
    }
}
