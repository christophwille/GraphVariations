...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.FileHash? FileHash { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.FileHash FileHash { get; set; }
#endif
        /// <summary>The integrity level of the process. Possible values are: unknown, untrusted, low, medium, high, system.</summary>
        public global::NoBackingStore.Graph.Models.ProcessIntegrityLevel? IntegrityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Process"/> and sets the default values.
        /// </summary>
        public Process()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Process"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.Process CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Process();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fileHash", n => { FileHash = n.GetObjectValue<global::NoBackingStore.Graph.Models.FileHash>(global::NoBackingStore.Graph.Models.FileHash.CreateFromDiscriminatorValue); } },
                { "integrityLevel", n => { IntegrityLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.ProcessIntegrityLevel>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.FileHash>("fileHash", FileHash);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ProcessIntegrityLevel>("integrityLevel", IntegrityLevel);
