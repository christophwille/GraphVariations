...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.CloudPcUserRoleScopeTagInfo>? UserRoleScopeTags { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.CloudPcUserRoleScopeTagInfo> UserRoleScopeTags { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.CloudPcAuditActor"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CloudPcAuditActor"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.CloudPcAuditActor CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CloudPcAuditActor();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "userRoleScopeTags", n => { UserRoleScopeTags = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CloudPcUserRoleScopeTagInfo>(global::NoBackingStore.Graph.Models.CloudPcUserRoleScopeTagInfo.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CloudPcUserRoleScopeTagInfo>("userRoleScopeTags", UserRoleScopeTags);
