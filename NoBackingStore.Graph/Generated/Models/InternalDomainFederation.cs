...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class InternalDomainFederation : global::NoBackingStore.Graph.Models.SamlOrWsFedProvider, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.FederatedIdpMfaBehavior? FederatedIdpMfaBehavior { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.PromptLoginBehavior? PromptLoginBehavior { get; set; }
        /// <summary>Provides status and timestamp of the last update of the signing certificate.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.SigningCertificateUpdateStatus? SigningCertificateUpdateStatus { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.SigningCertificateUpdateStatus SigningCertificateUpdateStatus { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.InternalDomainFederation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.InternalDomainFederation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.InternalDomainFederation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.InternalDomainFederation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "federatedIdpMfaBehavior", n => { FederatedIdpMfaBehavior = n.GetEnumValue<global::NoBackingStore.Graph.Models.FederatedIdpMfaBehavior>(); } },
                ...
                { "promptLoginBehavior", n => { PromptLoginBehavior = n.GetEnumValue<global::NoBackingStore.Graph.Models.PromptLoginBehavior>(); } },
                { "signOutUri", n => { SignOutUri = n.GetStringValue(); } },
                { "signingCertificateUpdateStatus", n => { SigningCertificateUpdateStatus = n.GetObjectValue<global::NoBackingStore.Graph.Models.SigningCertificateUpdateStatus>(global::NoBackingStore.Graph.Models.SigningCertificateUpdateStatus.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.FederatedIdpMfaBehavior>("federatedIdpMfaBehavior", FederatedIdpMfaBehavior);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PromptLoginBehavior>("promptLoginBehavior", PromptLoginBehavior);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.SigningCertificateUpdateStatus>("signingCertificateUpdateStatus", SigningCertificateUpdateStatus);
