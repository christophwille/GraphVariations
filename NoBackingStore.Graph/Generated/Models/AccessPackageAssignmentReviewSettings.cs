...
namespace NoBackingStore.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.AccessReviewExpirationBehavior? ExpirationBehavior { get; set; }
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.SubjectSet>? FallbackReviewers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.SubjectSet> FallbackReviewers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.SubjectSet>? PrimaryReviewers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.SubjectSet> PrimaryReviewers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.AccessPackageAssignmentReviewSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AccessPackageAssignmentReviewSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.AccessPackageAssignmentReviewSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AccessPackageAssignmentReviewSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "expirationBehavior", n => { ExpirationBehavior = n.GetEnumValue<global::NoBackingStore.Graph.Models.AccessReviewExpirationBehavior>(); } },
                { "fallbackReviewers", n => { FallbackReviewers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SubjectSet>(global::NoBackingStore.Graph.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "primaryReviewers", n => { PrimaryReviewers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SubjectSet>(global::NoBackingStore.Graph.Models.SubjectSet.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AccessReviewExpirationBehavior>("expirationBehavior", ExpirationBehavior);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SubjectSet>("fallbackReviewers", FallbackReviewers);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SubjectSet>("primaryReviewers", PrimaryReviewers);
