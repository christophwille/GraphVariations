...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Invitation : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public global::NoBackingStore.Graph.Models.User? InvitedUser { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.User InvitedUser { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.InvitedUserMessageInfo? InvitedUserMessageInfo { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.InvitedUserMessageInfo InvitedUserMessageInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DirectoryObject>? InvitedUserSponsors { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DirectoryObject> InvitedUserSponsors { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Invitation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Invitation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Invitation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "invitedUser", n => { InvitedUser = n.GetObjectValue<global::NoBackingStore.Graph.Models.User>(global::NoBackingStore.Graph.Models.User.CreateFromDiscriminatorValue); } },
                ...
                { "invitedUserMessageInfo", n => { InvitedUserMessageInfo = n.GetObjectValue<global::NoBackingStore.Graph.Models.InvitedUserMessageInfo>(global::NoBackingStore.Graph.Models.InvitedUserMessageInfo.CreateFromDiscriminatorValue); } },
                { "invitedUserSponsors", n => { InvitedUserSponsors = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>(global::NoBackingStore.Graph.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.User>("invitedUser", InvitedUser);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.InvitedUserMessageInfo>("invitedUserMessageInfo", InvitedUserMessageInfo);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>("invitedUserSponsors", InvitedUserSponsors);
