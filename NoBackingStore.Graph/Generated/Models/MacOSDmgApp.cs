...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class MacOSDmgApp : global::NoBackingStore.Graph.Models.MobileLobApp, IParsable
    {
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.MacOSIncludedApp>? IncludedApps { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.MacOSIncludedApp> IncludedApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MacOSDmgApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MacOSDmgApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.MacOSDmgApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MacOSDmgApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "includedApps", n => { IncludedApps = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.MacOSIncludedApp>(global::NoBackingStore.Graph.Models.MacOSIncludedApp.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.MacOSIncludedApp>("includedApps", IncludedApps);
