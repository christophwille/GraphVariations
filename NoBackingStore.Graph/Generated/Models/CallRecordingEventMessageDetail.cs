...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CallRecordingEventMessageDetail : global::NoBackingStore.Graph.Models.EventMessageDetail, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecordingStatus? CallRecordingStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.IdentitySet? MeetingOrganizer { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.IdentitySet MeetingOrganizer { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.CallRecordingEventMessageDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CallRecordingEventMessageDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CallRecordingEventMessageDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CallRecordingEventMessageDetail();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "callRecordingStatus", n => { CallRecordingStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecordingStatus>(); } },
                ...
                { "meetingOrganizer", n => { MeetingOrganizer = n.GetObjectValue<global::NoBackingStore.Graph.Models.IdentitySet>(global::NoBackingStore.Graph.Models.IdentitySet.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecordingStatus>("callRecordingStatus", CallRecordingStatus);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.IdentitySet>("meetingOrganizer", MeetingOrganizer);
        }
    }
}
