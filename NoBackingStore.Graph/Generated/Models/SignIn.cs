...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SignIn : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppliedConditionalAccessPolicy>? AppliedConditionalAccessPolicies { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppliedConditionalAccessPolicy> AppliedConditionalAccessPolicies { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.ConditionalAccessStatus? ConditionalAccessStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.DeviceDetail? DeviceDetail { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.DeviceDetail DeviceDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.SignInLocation? Location { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.SignInLocation Location { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.RiskEventType?>? RiskEventTypes { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.RiskEventType?> RiskEventTypes { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.RiskLevel? RiskLevelAggregated { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.RiskLevel? RiskLevelDuringSignIn { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.SignInStatus? Status { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.SignInStatus Status { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SignIn"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.SignIn CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SignIn();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "appliedConditionalAccessPolicies", n => { AppliedConditionalAccessPolicies = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppliedConditionalAccessPolicy>(global::NoBackingStore.Graph.Models.AppliedConditionalAccessPolicy.CreateFromDiscriminatorValue)?.AsList(); } },
                { "clientAppUsed", n => { ClientAppUsed = n.GetStringValue(); } },
                { "conditionalAccessStatus", n => { ConditionalAccessStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.ConditionalAccessStatus>(); } },
                { "correlationId", n => { CorrelationId = n.GetStringValue(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "deviceDetail", n => { DeviceDetail = n.GetObjectValue<global::NoBackingStore.Graph.Models.DeviceDetail>(global::NoBackingStore.Graph.Models.DeviceDetail.CreateFromDiscriminatorValue); } },
                { "ipAddress", n => { IpAddress = n.GetStringValue(); } },
                { "isInteractive", n => { IsInteractive = n.GetBoolValue(); } },
                { "location", n => { Location = n.GetObjectValue<global::NoBackingStore.Graph.Models.SignInLocation>(global::NoBackingStore.Graph.Models.SignInLocation.CreateFromDiscriminatorValue); } },
                ...
                { "riskEventTypes", n => { RiskEventTypes = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.RiskEventType>()?.AsList(); } },
                { "riskEventTypes_v2", n => { RiskEventTypesV2 = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "riskLevelAggregated", n => { RiskLevelAggregated = n.GetEnumValue<global::NoBackingStore.Graph.Models.RiskLevel>(); } },
                { "riskLevelDuringSignIn", n => { RiskLevelDuringSignIn = n.GetEnumValue<global::NoBackingStore.Graph.Models.RiskLevel>(); } },
                { "riskState", n => { RiskState = n.GetEnumValue<global::NoBackingStore.Graph.Models.RiskState>(); } },
                { "status", n => { Status = n.GetObjectValue<global::NoBackingStore.Graph.Models.SignInStatus>(global::NoBackingStore.Graph.Models.SignInStatus.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppliedConditionalAccessPolicy>("appliedConditionalAccessPolicies", AppliedConditionalAccessPolicies);
            writer.WriteStringValue("clientAppUsed", ClientAppUsed);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ConditionalAccessStatus>("conditionalAccessStatus", ConditionalAccessStatus);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.DeviceDetail>("deviceDetail", DeviceDetail);
            writer.WriteStringValue("ipAddress", IpAddress);
            writer.WriteBoolValue("isInteractive", IsInteractive);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.SignInLocation>("location", Location);
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.RiskEventType>("riskEventTypes", RiskEventTypes);
            writer.WriteCollectionOfPrimitiveValues<string>("riskEventTypes_v2", RiskEventTypesV2);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.RiskLevel>("riskLevelAggregated", RiskLevelAggregated);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.RiskLevel>("riskLevelDuringSignIn", RiskLevelDuringSignIn);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.RiskState>("riskState", RiskState);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.SignInStatus>("status", Status);
