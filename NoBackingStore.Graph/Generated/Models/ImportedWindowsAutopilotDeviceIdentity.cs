...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class ImportedWindowsAutopilotDeviceIdentity : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState? State { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState State { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetObjectValue<global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState>(global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.ImportedWindowsAutopilotDeviceIdentityState>("state", State);
        }
    }
}
