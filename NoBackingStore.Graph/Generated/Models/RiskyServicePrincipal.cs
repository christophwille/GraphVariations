...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class RiskyServicePrincipal : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.RiskyServicePrincipalHistoryItem>? History { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.RiskyServicePrincipalHistoryItem> History { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.RiskyServicePrincipal"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.RiskyServicePrincipal CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::NoBackingStore.Graph.Models.RiskyServicePrincipal(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "history", n => { History = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.RiskyServicePrincipalHistoryItem>(global::NoBackingStore.Graph.Models.RiskyServicePrincipalHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.RiskyServicePrincipalHistoryItem>("history", History);
