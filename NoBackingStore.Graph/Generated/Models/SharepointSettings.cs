...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SharepointSettings : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.IdleSessionSignOut? IdleSessionSignOut { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.IdleSessionSignOut IdleSessionSignOut { get; set; }
#endif
        /// <summary>Specifies the image tagging option for the tenant. Possible values are: disabled, basic, enhanced.</summary>
        public global::NoBackingStore.Graph.Models.ImageTaggingChoice? ImageTaggingOption { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.SharingCapabilities? SharingCapability { get; set; }
        /// <summary>Specifies the external sharing mode for domains. Possible values are: none, allowList, blockList.</summary>
        public global::NoBackingStore.Graph.Models.SharingDomainRestrictionMode? SharingDomainRestrictionMode { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SharepointSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.SharepointSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SharepointSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "idleSessionSignOut", n => { IdleSessionSignOut = n.GetObjectValue<global::NoBackingStore.Graph.Models.IdleSessionSignOut>(global::NoBackingStore.Graph.Models.IdleSessionSignOut.CreateFromDiscriminatorValue); } },
                { "imageTaggingOption", n => { ImageTaggingOption = n.GetEnumValue<global::NoBackingStore.Graph.Models.ImageTaggingChoice>(); } },
                ...
                { "sharingCapability", n => { SharingCapability = n.GetEnumValue<global::NoBackingStore.Graph.Models.SharingCapabilities>(); } },
                { "sharingDomainRestrictionMode", n => { SharingDomainRestrictionMode = n.GetEnumValue<global::NoBackingStore.Graph.Models.SharingDomainRestrictionMode>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.IdleSessionSignOut>("idleSessionSignOut", IdleSessionSignOut);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ImageTaggingChoice>("imageTaggingOption", ImageTaggingOption);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SharingCapabilities>("sharingCapability", SharingCapability);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SharingDomainRestrictionMode>("sharingDomainRestrictionMode", SharingDomainRestrictionMode);
