...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SharedPCConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy? AccountManagerPolicy { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy AccountManagerPolicy { get; set; }
#endif
        /// <summary>Type of accounts that are allowed to share the PC.</summary>
        public global::NoBackingStore.Graph.Models.SharedPCAllowedAccountType? AllowedAccounts { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.SharedPCConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SharedPCConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.SharedPCConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SharedPCConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountManagerPolicy", n => { AccountManagerPolicy = n.GetObjectValue<global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy>(global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy.CreateFromDiscriminatorValue); } },
                { "allowLocalStorage", n => { AllowLocalStorage = n.GetBoolValue(); } },
                { "allowedAccounts", n => { AllowedAccounts = n.GetEnumValue<global::NoBackingStore.Graph.Models.SharedPCAllowedAccountType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy>("accountManagerPolicy", AccountManagerPolicy);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SharedPCAllowedAccountType>("allowedAccounts", AllowedAccounts);
