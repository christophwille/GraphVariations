...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class LearningProvider : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.LearningContent>? LearningContents { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.LearningContent> LearningContents { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.LearningCourseActivity>? LearningCourseActivities { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.LearningCourseActivity> LearningCourseActivities { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.LearningProvider"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.LearningProvider CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.LearningProvider();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "learningContents", n => { LearningContents = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.LearningContent>(global::NoBackingStore.Graph.Models.LearningContent.CreateFromDiscriminatorValue)?.AsList(); } },
                { "learningCourseActivities", n => { LearningCourseActivities = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.LearningCourseActivity>(global::NoBackingStore.Graph.Models.LearningCourseActivity.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.LearningContent>("learningContents", LearningContents);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.LearningCourseActivity>("learningCourseActivities", LearningCourseActivities);
