...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class WindowsAutopilotDeploymentProfile : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
        /// <summary>The list of assigned devices for the profile.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceIdentity>? AssignedDevices { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceIdentity> AssignedDevices { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceType? DeviceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.OutOfBoxExperienceSetting? OutOfBoxExperienceSetting { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.OutOfBoxExperienceSetting OutOfBoxExperienceSetting { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.WindowsAutopilotDeploymentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.WindowsAutopilotDeploymentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.WindowsAutopilotDeploymentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignedDevices", n => { AssignedDevices = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceIdentity>(global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceIdentity.CreateFromDiscriminatorValue)?.AsList(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "deviceNameTemplate", n => { DeviceNameTemplate = n.GetStringValue(); } },
                { "deviceType", n => { DeviceType = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceType>(); } },
                ...
                { "outOfBoxExperienceSetting", n => { OutOfBoxExperienceSetting = n.GetObjectValue<global::NoBackingStore.Graph.Models.OutOfBoxExperienceSetting>(global::NoBackingStore.Graph.Models.OutOfBoxExperienceSetting.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceIdentity>("assignedDevices", AssignedDevices);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("deviceNameTemplate", DeviceNameTemplate);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsAutopilotDeviceType>("deviceType", DeviceType);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.OutOfBoxExperienceSetting>("outOfBoxExperienceSetting", OutOfBoxExperienceSetting);
