...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SchemaExtension : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ExtensionSchemaProperty>? Properties { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ExtensionSchemaProperty> Properties { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SchemaExtension"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.SchemaExtension CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SchemaExtension();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "properties", n => { Properties = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ExtensionSchemaProperty>(global::NoBackingStore.Graph.Models.ExtensionSchemaProperty.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ExtensionSchemaProperty>("properties", Properties);
