...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class AnalyzedMessageEvidence : global::NoBackingStore.Graph.Models.Security.AlertEvidence, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.EmailSender? P1Sender { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.EmailSender P1Sender { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.EmailSender? P2Sender { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.EmailSender P2Sender { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Security.AnalyzedMessageEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.AnalyzedMessageEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.AnalyzedMessageEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.AnalyzedMessageEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "p1Sender", n => { P1Sender = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.EmailSender>(global::NoBackingStore.Graph.Models.Security.EmailSender.CreateFromDiscriminatorValue); } },
                { "p2Sender", n => { P2Sender = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.EmailSender>(global::NoBackingStore.Graph.Models.Security.EmailSender.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.EmailSender>("p1Sender", P1Sender);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.EmailSender>("p2Sender", P2Sender);
