...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class IoTDeviceEvidence : global::NoBackingStore.Graph.Models.Security.AlertEvidence, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.IoTDeviceImportanceType? Importance { get; set; }
        /// <summary>The azureResourceEvidence entity that represents the IoT Hub that the device belongs to.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.AzureResourceEvidence? IoTHub { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.AzureResourceEvidence IoTHub { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Security.NicEvidence>? Nics { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Security.NicEvidence> Nics { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.UrlEvidence? SourceRef { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.UrlEvidence SourceRef { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Security.IoTDeviceEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.IoTDeviceEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.IoTDeviceEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.IoTDeviceEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "importance", n => { Importance = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.IoTDeviceImportanceType>(); } },
                { "ioTHub", n => { IoTHub = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.AzureResourceEvidence>(global::NoBackingStore.Graph.Models.Security.AzureResourceEvidence.CreateFromDiscriminatorValue); } },
                ...
                { "nics", n => { Nics = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.NicEvidence>(global::NoBackingStore.Graph.Models.Security.NicEvidence.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "sourceRef", n => { SourceRef = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.UrlEvidence>(global::NoBackingStore.Graph.Models.Security.UrlEvidence.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.IoTDeviceImportanceType>("importance", Importance);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.AzureResourceEvidence>("ioTHub", IoTHub);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.NicEvidence>("nics", Nics);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.UrlEvidence>("sourceRef", SourceRef);
