...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class HealthIssue : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.HealthIssueType? HealthIssueType { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.HealthIssueSeverity? Severity { get; set; }
        /// <summary>The status of the health issue. The possible values are: open, closed, suppressed, unknownFutureValue.</summary>
        public global::NoBackingStore.Graph.Models.Security.HealthIssueStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.HealthIssue"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.HealthIssue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.HealthIssue();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "healthIssueType", n => { HealthIssueType = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueType>(); } },
                ...
                { "severity", n => { Severity = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueSeverity>(); } },
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueType>("healthIssueType", HealthIssueType);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueSeverity>("severity", Severity);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.HealthIssueStatus>("status", Status);
        }
    }
}
