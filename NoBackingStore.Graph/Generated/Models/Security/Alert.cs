...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.Dictionary? AdditionalDataProperty { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.Dictionary AdditionalDataProperty { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.AlertClassification? Classification { get; set; }
        /// <summary>Array of comments created by the Security Operations (SecOps) team during the alert management process.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Security.AlertComment>? Comments { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Security.AlertComment> Comments { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.DetectionSource? DetectionSource { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.AlertDetermination? Determination { get; set; }
        /// <summary>Collection of evidence related to the alert.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Security.AlertEvidence>? Evidence { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Security.AlertEvidence> Evidence { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.ServiceSource? ServiceSource { get; set; }
        /// <summary>The severity property</summary>
        public global::NoBackingStore.Graph.Models.Security.AlertSeverity? Severity { get; set; }
        /// <summary>The status property</summary>
        public global::NoBackingStore.Graph.Models.Security.AlertStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.Alert"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.Alert CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.Alert();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalData", n => { AdditionalDataProperty = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.Dictionary>(global::NoBackingStore.Graph.Models.Security.Dictionary.CreateFromDiscriminatorValue); } },
                { "alertPolicyId", n => { AlertPolicyId = n.GetStringValue(); } },
                { "alertWebUrl", n => { AlertWebUrl = n.GetStringValue(); } },
                { "assignedTo", n => { AssignedTo = n.GetStringValue(); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "classification", n => { Classification = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.AlertClassification>(); } },
                { "comments", n => { Comments = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.AlertComment>(global::NoBackingStore.Graph.Models.Security.AlertComment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "detectionSource", n => { DetectionSource = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.DetectionSource>(); } },
                { "detectorId", n => { DetectorId = n.GetStringValue(); } },
                { "determination", n => { Determination = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.AlertDetermination>(); } },
                { "evidence", n => { Evidence = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.AlertEvidence>(global::NoBackingStore.Graph.Models.Security.AlertEvidence.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "serviceSource", n => { ServiceSource = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.ServiceSource>(); } },
                { "severity", n => { Severity = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.AlertSeverity>(); } },
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.AlertStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.Dictionary>("additionalData", AdditionalDataProperty);
            writer.WriteStringValue("alertPolicyId", AlertPolicyId);
            writer.WriteStringValue("alertWebUrl", AlertWebUrl);
            writer.WriteStringValue("assignedTo", AssignedTo);
            writer.WriteStringValue("category", Category);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.AlertClassification>("classification", Classification);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.AlertComment>("comments", Comments);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.DetectionSource>("detectionSource", DetectionSource);
            writer.WriteStringValue("detectorId", DetectorId);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.AlertDetermination>("determination", Determination);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.AlertEvidence>("evidence", Evidence);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.ServiceSource>("serviceSource", ServiceSource);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.AlertSeverity>("severity", Severity);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.AlertStatus>("status", Status);
