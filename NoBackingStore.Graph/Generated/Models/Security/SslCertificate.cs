...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class SslCertificate : global::NoBackingStore.Graph.Models.Security.Artifact, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.SslCertificateEntity? Issuer { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.SslCertificateEntity Issuer { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Security.Host>? RelatedHosts { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Security.Host> RelatedHosts { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.SslCertificateEntity? Subject { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.SslCertificateEntity Subject { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Security.SslCertificate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.SslCertificate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.SslCertificate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.SslCertificate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "issuer", n => { Issuer = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.SslCertificateEntity>(global::NoBackingStore.Graph.Models.Security.SslCertificateEntity.CreateFromDiscriminatorValue); } },
                { "lastSeenDateTime", n => { LastSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "relatedHosts", n => { RelatedHosts = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.Host>(global::NoBackingStore.Graph.Models.Security.Host.CreateFromDiscriminatorValue)?.AsList(); } },
                { "serialNumber", n => { SerialNumber = n.GetStringValue(); } },
                { "sha1", n => { Sha1 = n.GetStringValue(); } },
                { "subject", n => { Subject = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.SslCertificateEntity>(global::NoBackingStore.Graph.Models.Security.SslCertificateEntity.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.SslCertificateEntity>("issuer", Issuer);
            writer.WriteDateTimeOffsetValue("lastSeenDateTime", LastSeenDateTime);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.Host>("relatedHosts", RelatedHosts);
            writer.WriteStringValue("serialNumber", SerialNumber);
            writer.WriteStringValue("sha1", Sha1);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.SslCertificateEntity>("subject", Subject);
        }
    }
}
