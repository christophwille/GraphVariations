...
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.HostComponent? Component { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.HostComponent Component { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Security.HostPortComponent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.HostPortComponent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.Security.HostPortComponent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.HostPortComponent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "component", n => { Component = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.HostComponent>(global::NoBackingStore.Graph.Models.Security.HostComponent.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.HostComponent>("component", Component);
