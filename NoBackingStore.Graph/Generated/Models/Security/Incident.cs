...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class Incident : global::NoBackingStore.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The list of related alerts. Supports $expand.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Security.Alert>? Alerts { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Security.Alert> Alerts { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.Security.IncidentStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.Incident"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.Incident CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.Incident();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alerts", n => { Alerts = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.Alert>(global::NoBackingStore.Graph.Models.Security.Alert.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.Security.IncidentStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Security.Alert>("alerts", Alerts);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Security.IncidentStatus>("status", Status);
