...
namespace NoBackingStore.Graph.Models.Security
{
    ...
    public partial class ProcessEvidence : global::NoBackingStore.Graph.Models.Security.AlertEvidence, IParsable
...
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.FileDetails? ImageFile { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.FileDetails ImageFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.FileDetails? ParentProcessImageFile { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.FileDetails ParentProcessImageFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Security.UserAccount? UserAccount { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Security.UserAccount UserAccount { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Security.ProcessEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Security.ProcessEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Security.ProcessEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Security.ProcessEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "imageFile", n => { ImageFile = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.FileDetails>(global::NoBackingStore.Graph.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
                ...
                { "parentProcessImageFile", n => { ParentProcessImageFile = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.FileDetails>(global::NoBackingStore.Graph.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
                ...
                { "userAccount", n => { UserAccount = n.GetObjectValue<global::NoBackingStore.Graph.Models.Security.UserAccount>(global::NoBackingStore.Graph.Models.Security.UserAccount.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.FileDetails>("imageFile", ImageFile);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.FileDetails>("parentProcessImageFile", ParentProcessImageFile);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Security.UserAccount>("userAccount", UserAccount);
        }
    }
}
