...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ExternalConnectors.Label?>? Labels { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ExternalConnectors.Label?> Labels { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.ExternalConnectors.Property"/> and sets the default values.
        /// </summary>
        public Property()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ExternalConnectors.Property"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.ExternalConnectors.Property CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.ExternalConnectors.Property();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "labels", n => { Labels = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.ExternalConnectors.Label>()?.AsList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.ExternalConnectors.Label>("labels", Labels);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyType>("type", Type);
