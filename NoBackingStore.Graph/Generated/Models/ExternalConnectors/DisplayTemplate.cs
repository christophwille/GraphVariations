...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyRule>? Rules { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyRule> Rules { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.ExternalConnectors.DisplayTemplate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ExternalConnectors.DisplayTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.ExternalConnectors.DisplayTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.ExternalConnectors.DisplayTemplate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "rules", n => { Rules = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyRule>(global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyRule.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ExternalConnectors.PropertyRule>("rules", Rules);
