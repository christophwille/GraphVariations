...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AndroidWorkProfileGeneralDeviceConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
        ...
        public global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType? PasswordRequiredType { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.AndroidWorkProfileCrossProfileDataSharingType? WorkProfileDataSharingType { get; set; }
        /// <summary>Android Work Profile default app permission policy type.</summary>
        public global::NoBackingStore.Graph.Models.AndroidWorkProfileDefaultAppPermissionPolicyType? WorkProfileDefaultAppPermissionPolicy { get; set; }
        ...
        /// <summary>Android Work Profile required password type.</summary>
        public global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType? WorkProfilePasswordRequiredType { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.AndroidWorkProfileGeneralDeviceConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AndroidWorkProfileGeneralDeviceConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AndroidWorkProfileGeneralDeviceConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AndroidWorkProfileGeneralDeviceConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "passwordRequiredType", n => { PasswordRequiredType = n.GetEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType>(); } },
                ...
                { "workProfileDataSharingType", n => { WorkProfileDataSharingType = n.GetEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileCrossProfileDataSharingType>(); } },
                { "workProfileDefaultAppPermissionPolicy", n => { WorkProfileDefaultAppPermissionPolicy = n.GetEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileDefaultAppPermissionPolicyType>(); } },
                ...
                { "workProfilePasswordRequiredType", n => { WorkProfilePasswordRequiredType = n.GetEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType>("passwordRequiredType", PasswordRequiredType);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileCrossProfileDataSharingType>("workProfileDataSharingType", WorkProfileDataSharingType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileDefaultAppPermissionPolicyType>("workProfileDefaultAppPermissionPolicy", WorkProfileDefaultAppPermissionPolicy);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AndroidWorkProfileRequiredPasswordType>("workProfilePasswordRequiredType", WorkProfilePasswordRequiredType);
