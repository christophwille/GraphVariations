...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SecureScoreControlProfile : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ComplianceInformation>? ComplianceInformation { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ComplianceInformation> ComplianceInformation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.SecureScoreControlStateUpdate>? ControlStateUpdates { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.SecureScoreControlStateUpdate> ControlStateUpdates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SecureScoreControlProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.SecureScoreControlProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SecureScoreControlProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "complianceInformation", n => { ComplianceInformation = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ComplianceInformation>(global::NoBackingStore.Graph.Models.ComplianceInformation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "controlCategory", n => { ControlCategory = n.GetStringValue(); } },
                { "controlStateUpdates", n => { ControlStateUpdates = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SecureScoreControlStateUpdate>(global::NoBackingStore.Graph.Models.SecureScoreControlStateUpdate.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ComplianceInformation>("complianceInformation", ComplianceInformation);
            writer.WriteStringValue("controlCategory", ControlCategory);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SecureScoreControlStateUpdate>("controlStateUpdates", ControlStateUpdates);
