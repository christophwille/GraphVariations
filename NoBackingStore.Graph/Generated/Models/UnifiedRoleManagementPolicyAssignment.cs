...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UnifiedRoleManagementPolicyAssignment : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicy? Policy { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicy Policy { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicyAssignment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicyAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicyAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "policy", n => { Policy = n.GetObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicy>(global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicy.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleManagementPolicy>("policy", Policy);
