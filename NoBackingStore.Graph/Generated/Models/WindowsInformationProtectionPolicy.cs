...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class WindowsInformationProtectionPolicy : global::NoBackingStore.Graph.Models.WindowsInformationProtection, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements? PinLowercaseLetters { get; set; }
        ...
        /// <summary>Pin Character Requirements</summary>
        public global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements? PinSpecialCharacters { get; set; }
        /// <summary>Pin Character Requirements</summary>
        public global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements? PinUppercaseLetters { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.WindowsInformationProtectionPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.WindowsInformationProtectionPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.WindowsInformationProtectionPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.WindowsInformationProtectionPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseLetters", n => { PinLowercaseLetters = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinMinimumLength", n => { PinMinimumLength = n.GetIntValue(); } },
                { "pinSpecialCharacters", n => { PinSpecialCharacters = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinUppercaseLetters", n => { PinUppercaseLetters = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
