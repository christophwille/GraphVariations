...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DayOfWeekObject?>? DaysOfWeek { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DayOfWeekObject?> DaysOfWeek { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.DayOfWeekObject? FirstDayOfWeek { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.WeekIndex? Index { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.RecurrencePatternType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.RecurrencePattern"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.RecurrencePattern"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.RecurrencePattern CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.RecurrencePattern();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "daysOfWeek", n => { DaysOfWeek = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.DayOfWeekObject>()?.AsList(); } },
                { "firstDayOfWeek", n => { FirstDayOfWeek = n.GetEnumValue<global::NoBackingStore.Graph.Models.DayOfWeekObject>(); } },
                { "index", n => { Index = n.GetEnumValue<global::NoBackingStore.Graph.Models.WeekIndex>(); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "month", n => { Month = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::NoBackingStore.Graph.Models.RecurrencePatternType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.DayOfWeekObject>("daysOfWeek", DaysOfWeek);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DayOfWeekObject>("firstDayOfWeek", FirstDayOfWeek);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WeekIndex>("index", Index);
            writer.WriteIntValue("interval", Interval);
            writer.WriteIntValue("month", Month);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.RecurrencePatternType>("type", Type);
