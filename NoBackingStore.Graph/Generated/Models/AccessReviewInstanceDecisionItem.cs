...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AccessReviewInstanceDecisionItem : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.UserIdentity? AppliedBy { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UserIdentity AppliedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.GovernanceInsight>? Insights { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.GovernanceInsight> Insights { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Identity? Principal { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Identity Principal { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItemResource? Resource { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItemResource Resource { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.UserIdentity? ReviewedBy { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UserIdentity ReviewedBy { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItem();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "appliedBy", n => { AppliedBy = n.GetObjectValue<global::NoBackingStore.Graph.Models.UserIdentity>(global::NoBackingStore.Graph.Models.UserIdentity.CreateFromDiscriminatorValue); } },
                ...
                { "insights", n => { Insights = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.GovernanceInsight>(global::NoBackingStore.Graph.Models.GovernanceInsight.CreateFromDiscriminatorValue)?.AsList(); } },
                { "justification", n => { Justification = n.GetStringValue(); } },
                { "principal", n => { Principal = n.GetObjectValue<global::NoBackingStore.Graph.Models.Identity>(global::NoBackingStore.Graph.Models.Identity.CreateFromDiscriminatorValue); } },
                { "principalLink", n => { PrincipalLink = n.GetStringValue(); } },
                { "recommendation", n => { Recommendation = n.GetStringValue(); } },
                { "resource", n => { Resource = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItemResource>(global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItemResource.CreateFromDiscriminatorValue); } },
                { "resourceLink", n => { ResourceLink = n.GetStringValue(); } },
                { "reviewedBy", n => { ReviewedBy = n.GetObjectValue<global::NoBackingStore.Graph.Models.UserIdentity>(global::NoBackingStore.Graph.Models.UserIdentity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UserIdentity>("appliedBy", AppliedBy);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.GovernanceInsight>("insights", Insights);
            writer.WriteStringValue("justification", Justification);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Identity>("principal", Principal);
            writer.WriteStringValue("principalLink", PrincipalLink);
            writer.WriteStringValue("recommendation", Recommendation);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessReviewInstanceDecisionItemResource>("resource", Resource);
            writer.WriteStringValue("resourceLink", ResourceLink);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UserIdentity>("reviewedBy", ReviewedBy);
