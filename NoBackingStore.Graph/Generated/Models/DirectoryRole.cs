...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DirectoryRole : global::NoBackingStore.Graph.Models.DirectoryObject, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ScopedRoleMembership>? ScopedMembers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ScopedRoleMembership> ScopedMembers { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.DirectoryRole"/> and sets the default values.
        /// </summary>
        ...
        public static new global::NoBackingStore.Graph.Models.DirectoryRole CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DirectoryRole();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "scopedMembers", n => { ScopedMembers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ScopedRoleMembership>(global::NoBackingStore.Graph.Models.ScopedRoleMembership.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ScopedRoleMembership>("scopedMembers", ScopedMembers);
        }
    }
}
