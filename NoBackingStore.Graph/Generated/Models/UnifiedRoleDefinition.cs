...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UnifiedRoleDefinition : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition>? InheritsPermissionsFrom { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition> InheritsPermissionsFrom { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.UnifiedRolePermission>? RolePermissions { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.UnifiedRolePermission> RolePermissions { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UnifiedRoleDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.UnifiedRoleDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UnifiedRoleDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "inheritsPermissionsFrom", n => { InheritsPermissionsFrom = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition>(global::NoBackingStore.Graph.Models.UnifiedRoleDefinition.CreateFromDiscriminatorValue)?.AsList(); } },
                { "isBuiltIn", n => { IsBuiltIn = n.GetBoolValue(); } },
                { "isEnabled", n => { IsEnabled = n.GetBoolValue(); } },
                { "resourceScopes", n => { ResourceScopes = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "rolePermissions", n => { RolePermissions = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.UnifiedRolePermission>(global::NoBackingStore.Graph.Models.UnifiedRolePermission.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition>("inheritsPermissionsFrom", InheritsPermissionsFrom);
            writer.WriteBoolValue("isBuiltIn", IsBuiltIn);
            writer.WriteBoolValue("isEnabled", IsEnabled);
            writer.WriteCollectionOfPrimitiveValues<string>("resourceScopes", ResourceScopes);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.UnifiedRolePermission>("rolePermissions", RolePermissions);
