...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AuthorizationPolicy : global::NoBackingStore.Graph.Models.PolicyBase, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.AllowInvitesFrom? AllowInvitesFrom { get; set; }
...
#nullable enable
        public global::NoBackingStore.Graph.Models.DefaultUserRolePermissions? DefaultUserRolePermissions { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.DefaultUserRolePermissions DefaultUserRolePermissions { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.AuthorizationPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AuthorizationPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AuthorizationPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AuthorizationPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "allowInvitesFrom", n => { AllowInvitesFrom = n.GetEnumValue<global::NoBackingStore.Graph.Models.AllowInvitesFrom>(); } },
                ...
                { "defaultUserRolePermissions", n => { DefaultUserRolePermissions = n.GetObjectValue<global::NoBackingStore.Graph.Models.DefaultUserRolePermissions>(global::NoBackingStore.Graph.Models.DefaultUserRolePermissions.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AllowInvitesFrom>("allowInvitesFrom", AllowInvitesFrom);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.DefaultUserRolePermissions>("defaultUserRolePermissions", DefaultUserRolePermissions);
