...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AndroidGeneralDeviceConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppListItem>? AppsHideList { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppListItem> AppsHideList { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppListItem>? AppsInstallAllowList { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppListItem> AppsInstallAllowList { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppListItem>? AppsLaunchBlockList { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppListItem> AppsLaunchBlockList { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppListItem>? KioskModeApps { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppListItem> KioskModeApps { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.WebBrowserCookieSettings? WebBrowserCookieSettings { get; set; }
        /// <summary>Indicates whether or not to block syncing Wi-Fi.</summary>
        public bool? WiFiBlocked { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.AndroidGeneralDeviceConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AndroidGeneralDeviceConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AndroidGeneralDeviceConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AndroidGeneralDeviceConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "appsHideList", n => { AppsHideList = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>(global::NoBackingStore.Graph.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "appsInstallAllowList", n => { AppsInstallAllowList = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>(global::NoBackingStore.Graph.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "appsLaunchBlockList", n => { AppsLaunchBlockList = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>(global::NoBackingStore.Graph.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "kioskModeApps", n => { KioskModeApps = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>(global::NoBackingStore.Graph.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "webBrowserCookieSettings", n => { WebBrowserCookieSettings = n.GetEnumValue<global::NoBackingStore.Graph.Models.WebBrowserCookieSettings>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>("appsHideList", AppsHideList);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>("appsInstallAllowList", AppsInstallAllowList);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>("appsLaunchBlockList", AppsLaunchBlockList);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>("kioskModeApps", KioskModeApps);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WebBrowserCookieSettings>("webBrowserCookieSettings", WebBrowserCookieSettings);
