...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CustomSecurityAttributeDefinition : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AllowedValue>? AllowedValues { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AllowedValue> AllowedValues { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CustomSecurityAttributeDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CustomSecurityAttributeDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CustomSecurityAttributeDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedValues", n => { AllowedValues = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AllowedValue>(global::NoBackingStore.Graph.Models.AllowedValue.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AllowedValue>("allowedValues", AllowedValues);
