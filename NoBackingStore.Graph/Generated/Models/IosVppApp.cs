...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class IosVppApp : global::NoBackingStore.Graph.Models.MobileApp, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.VppLicensingType? LicensingType { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.VppLicensingType LicensingType { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.IosVppApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.IosVppApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.IosVppApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.IosVppApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "licensingType", n => { LicensingType = n.GetObjectValue<global::NoBackingStore.Graph.Models.VppLicensingType>(global::NoBackingStore.Graph.Models.VppLicensingType.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.VppLicensingType>("licensingType", LicensingType);
