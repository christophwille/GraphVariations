...
namespace NoBackingStore.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.BroadcastMeetingAudience? AllowedAudience { get; set; }
        /// <summary>Caption settings of a Teams live event.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.BroadcastMeetingCaptionSettings? Captions { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.BroadcastMeetingCaptionSettings Captions { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.BroadcastMeetingSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.BroadcastMeetingSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.BroadcastMeetingSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.BroadcastMeetingSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedAudience", n => { AllowedAudience = n.GetEnumValue<global::NoBackingStore.Graph.Models.BroadcastMeetingAudience>(); } },
                { "captions", n => { Captions = n.GetObjectValue<global::NoBackingStore.Graph.Models.BroadcastMeetingCaptionSettings>(global::NoBackingStore.Graph.Models.BroadcastMeetingCaptionSettings.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.BroadcastMeetingAudience>("allowedAudience", AllowedAudience);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.BroadcastMeetingCaptionSettings>("captions", Captions);
