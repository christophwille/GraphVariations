...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class SharedPCAccountManagerPolicy : IAdditionalDataHolder, IParsable
    {
        ...
        public global::NoBackingStore.Graph.Models.SharedPCAccountDeletionPolicyType? AccountDeletionPolicy { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.SharedPCAccountManagerPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountDeletionPolicy", n => { AccountDeletionPolicy = n.GetEnumValue<global::NoBackingStore.Graph.Models.SharedPCAccountDeletionPolicyType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SharedPCAccountDeletionPolicyType>("accountDeletionPolicy", AccountDeletionPolicy);
