...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class WindowsProtectionState : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.WindowsDeviceMalwareState>? DetectedMalwareState { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.WindowsDeviceMalwareState> DetectedMalwareState { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.WindowsDeviceHealthState? DeviceState { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.WindowsDefenderProductStatus? ProductStatus { get; set; }
...
#nullable restore
        ...
        public static new global::NoBackingStore.Graph.Models.WindowsProtectionState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.WindowsProtectionState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "detectedMalwareState", n => { DetectedMalwareState = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WindowsDeviceMalwareState>(global::NoBackingStore.Graph.Models.WindowsDeviceMalwareState.CreateFromDiscriminatorValue)?.AsList(); } },
                { "deviceState", n => { DeviceState = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsDeviceHealthState>(); } },
                ...
                { "productStatus", n => { ProductStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsDefenderProductStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WindowsDeviceMalwareState>("detectedMalwareState", DetectedMalwareState);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsDeviceHealthState>("deviceState", DeviceState);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsDefenderProductStatus>("productStatus", ProductStatus);
