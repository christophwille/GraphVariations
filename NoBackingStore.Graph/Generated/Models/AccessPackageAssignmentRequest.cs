...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AccessPackageAssignmentRequest : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessPackageAnswer>? Answers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessPackageAnswer> Answers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessPackageAssignment? Assignment { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessPackageAssignment Assignment { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessPackageSubject? Requestor { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessPackageSubject Requestor { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AccessPackageAssignmentRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AccessPackageAssignmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AccessPackageAssignmentRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "answers", n => { Answers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessPackageAnswer>(global::NoBackingStore.Graph.Models.AccessPackageAnswer.CreateFromDiscriminatorValue)?.AsList(); } },
                { "assignment", n => { Assignment = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessPackageAssignment>(global::NoBackingStore.Graph.Models.AccessPackageAssignment.CreateFromDiscriminatorValue); } },
                ...
                { "requestor", n => { Requestor = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessPackageSubject>(global::NoBackingStore.Graph.Models.AccessPackageSubject.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessPackageAnswer>("answers", Answers);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessPackageAssignment>("assignment", Assignment);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessPackageSubject>("requestor", Requestor);
