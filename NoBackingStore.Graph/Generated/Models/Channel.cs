...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Channel : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.DriveItem? FilesFolder { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.DriveItem FilesFolder { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.ChannelMembershipType? MembershipType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.SharedWithChannelTeamInfo>? SharedWithTeams { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.SharedWithChannelTeamInfo> SharedWithTeams { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.ChannelSummary? Summary { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.ChannelSummary Summary { get; set; }
#endif
...
#nullable restore
        ...
        public static new global::NoBackingStore.Graph.Models.Channel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Channel();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "filesFolder", n => { FilesFolder = n.GetObjectValue<global::NoBackingStore.Graph.Models.DriveItem>(global::NoBackingStore.Graph.Models.DriveItem.CreateFromDiscriminatorValue); } },
                ...
                { "membershipType", n => { MembershipType = n.GetEnumValue<global::NoBackingStore.Graph.Models.ChannelMembershipType>(); } },
                ...
                { "sharedWithTeams", n => { SharedWithTeams = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SharedWithChannelTeamInfo>(global::NoBackingStore.Graph.Models.SharedWithChannelTeamInfo.CreateFromDiscriminatorValue)?.AsList(); } },
                { "summary", n => { Summary = n.GetObjectValue<global::NoBackingStore.Graph.Models.ChannelSummary>(global::NoBackingStore.Graph.Models.ChannelSummary.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.DriveItem>("filesFolder", FilesFolder);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ChannelMembershipType>("membershipType", MembershipType);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ChatMessage>("messages", Messages);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.SharedWithChannelTeamInfo>("sharedWithTeams", SharedWithTeams);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.ChannelSummary>("summary", Summary);
