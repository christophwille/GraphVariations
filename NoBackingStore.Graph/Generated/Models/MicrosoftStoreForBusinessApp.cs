...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class MicrosoftStoreForBusinessApp : global::NoBackingStore.Graph.Models.MobileApp, IParsable
    {
        /// <summary>The licenseType property</summary>
        public global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessLicenseType? LicenseType { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "licenseType", n => { LicenseType = n.GetEnumValue<global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessLicenseType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MicrosoftStoreForBusinessLicenseType>("licenseType", LicenseType);
