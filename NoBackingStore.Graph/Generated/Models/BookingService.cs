...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class BookingService : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.BookingQuestionAssignment>? CustomQuestions { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.BookingQuestionAssignment> CustomQuestions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Location? DefaultLocation { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Location DefaultLocation { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.BookingPriceType? DefaultPriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.BookingReminder>? DefaultReminders { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.BookingReminder> DefaultReminders { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.BookingService"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.BookingService CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.BookingService();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customQuestions", n => { CustomQuestions = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingQuestionAssignment>(global::NoBackingStore.Graph.Models.BookingQuestionAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "defaultDuration", n => { DefaultDuration = n.GetTimeSpanValue(); } },
                { "defaultLocation", n => { DefaultLocation = n.GetObjectValue<global::NoBackingStore.Graph.Models.Location>(global::NoBackingStore.Graph.Models.Location.CreateFromDiscriminatorValue); } },
                { "defaultPrice", n => { DefaultPrice = n.GetDoubleValue(); } },
                { "defaultPriceType", n => { DefaultPriceType = n.GetEnumValue<global::NoBackingStore.Graph.Models.BookingPriceType>(); } },
                { "defaultReminders", n => { DefaultReminders = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingReminder>(global::NoBackingStore.Graph.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingQuestionAssignment>("customQuestions", CustomQuestions);
            writer.WriteTimeSpanValue("defaultDuration", DefaultDuration);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Location>("defaultLocation", DefaultLocation);
            writer.WriteDoubleValue("defaultPrice", DefaultPrice);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.BookingPriceType>("defaultPriceType", DefaultPriceType);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingReminder>("defaultReminders", DefaultReminders);
