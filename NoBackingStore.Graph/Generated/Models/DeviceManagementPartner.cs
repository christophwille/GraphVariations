...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DeviceManagementPartner : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAssignment>? GroupsRequiringPartnerEnrollment { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAssignment> GroupsRequiringPartnerEnrollment { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.DeviceManagementPartnerAppType? PartnerAppType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DeviceManagementPartner"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DeviceManagementPartner CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DeviceManagementPartner();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupsRequiringPartnerEnrollment", n => { GroupsRequiringPartnerEnrollment = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAssignment>(global::NoBackingStore.Graph.Models.DeviceManagementPartnerAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "isConfigured", n => { IsConfigured = n.GetBoolValue(); } },
                { "lastHeartbeatDateTime", n => { LastHeartbeatDateTime = n.GetDateTimeOffsetValue(); } },
                { "partnerAppType", n => { PartnerAppType = n.GetEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAppType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAssignment>("groupsRequiringPartnerEnrollment", GroupsRequiringPartnerEnrollment);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementPartnerAppType>("partnerAppType", PartnerAppType);
