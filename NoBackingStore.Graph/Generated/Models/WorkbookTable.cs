...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class WorkbookTable : global::NoBackingStore.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The list of all the columns in the table. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.WorkbookTableColumn>? Columns { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.WorkbookTableColumn> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.WorkbookTableRow>? Rows { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.WorkbookTableRow> Rows { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.WorkbookTableSort? Sort { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.WorkbookTableSort Sort { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.WorkbookTable"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.WorkbookTable CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.WorkbookTable();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WorkbookTableColumn>(global::NoBackingStore.Graph.Models.WorkbookTableColumn.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rows", n => { Rows = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WorkbookTableRow>(global::NoBackingStore.Graph.Models.WorkbookTableRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::NoBackingStore.Graph.Models.WorkbookTableSort>(global::NoBackingStore.Graph.Models.WorkbookTableSort.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WorkbookTableColumn>("columns", Columns);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.WorkbookTableRow>("rows", Rows);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.WorkbookTableSort>("sort", Sort);
