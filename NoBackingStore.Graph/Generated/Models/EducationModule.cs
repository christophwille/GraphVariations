...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class EducationModule : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.EducationModuleResource>? Resources { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.EducationModuleResource> Resources { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.EducationModuleStatus? Status { get; private set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.EducationModule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.EducationModule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.EducationModule();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "resources", n => { Resources = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.EducationModuleResource>(global::NoBackingStore.Graph.Models.EducationModuleResource.CreateFromDiscriminatorValue)?.AsList(); } },
                { "resourcesFolderUrl", n => { ResourcesFolderUrl = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.EducationModuleStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.EducationModuleResource>("resources", Resources);
        }
    }
}
