...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CloudPcOnPremisesConnection : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionType? ConnectionType { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatus? HealthCheckStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatusDetail? HealthCheckStatusDetail { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatusDetail HealthCheckStatusDetail { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnection();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionType>(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "healthCheckStatus", n => { HealthCheckStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatus>(); } },
                { "healthCheckStatusDetail", n => { HealthCheckStatusDetail = n.GetObjectValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatusDetail>(global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatusDetail.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionType>("connectionType", ConnectionType);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatus>("healthCheckStatus", HealthCheckStatus);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.CloudPcOnPremisesConnectionStatusDetail>("healthCheckStatusDetail", HealthCheckStatusDetail);
