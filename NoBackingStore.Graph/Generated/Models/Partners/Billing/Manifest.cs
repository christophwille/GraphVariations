...
namespace NoBackingStore.Graph.Models.Partners.Billing
{
    ...
    public partial class Manifest : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Partners.Billing.Blob>? Blobs { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Partners.Billing.Blob> Blobs { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Partners.Billing.Manifest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Partners.Billing.Manifest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Partners.Billing.Manifest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "blobs", n => { Blobs = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Partners.Billing.Blob>(global::NoBackingStore.Graph.Models.Partners.Billing.Blob.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Partners.Billing.Blob>("blobs", Blobs);
