...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintColorMode?>? ColorModes { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintColorMode?> ColorModes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.IntegerRange? CopiesPerJob { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.IntegerRange CopiesPerJob { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintDuplexMode?>? DuplexModes { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintDuplexMode?> DuplexModes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrinterFeedOrientation?>? FeedOrientations { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrinterFeedOrientation?> FeedOrientations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintMultipageLayout?>? MultipageLayouts { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintMultipageLayout?> MultipageLayouts { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintOrientation?>? Orientations { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintOrientation?> Orientations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintQuality?>? Qualities { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintQuality?> Qualities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PrintScaling?>? Scalings { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PrintScaling?> Scalings { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.PrinterCapabilities"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.PrinterCapabilities"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.PrinterCapabilities CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.PrinterCapabilities();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "colorModes", n => { ColorModes = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintColorMode>()?.AsList(); } },
                { "contentTypes", n => { ContentTypes = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "copiesPerJob", n => { CopiesPerJob = n.GetObjectValue<global::NoBackingStore.Graph.Models.IntegerRange>(global::NoBackingStore.Graph.Models.IntegerRange.CreateFromDiscriminatorValue); } },
                { "dpis", n => { Dpis = n.GetCollectionOfPrimitiveValues<int?>()?.AsList(); } },
                { "duplexModes", n => { DuplexModes = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintDuplexMode>()?.AsList(); } },
                { "feedOrientations", n => { FeedOrientations = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrinterFeedOrientation>()?.AsList(); } },
                ...
                { "multipageLayouts", n => { MultipageLayouts = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintMultipageLayout>()?.AsList(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "orientations", n => { Orientations = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintOrientation>()?.AsList(); } },
                ...
                { "qualities", n => { Qualities = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintQuality>()?.AsList(); } },
                { "rightMargins", n => { RightMargins = n.GetCollectionOfPrimitiveValues<int?>()?.AsList(); } },
                { "scalings", n => { Scalings = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintScaling>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintColorMode>("colorModes", ColorModes);
            writer.WriteCollectionOfPrimitiveValues<string>("contentTypes", ContentTypes);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.IntegerRange>("copiesPerJob", CopiesPerJob);
            writer.WriteCollectionOfPrimitiveValues<int?>("dpis", Dpis);
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintDuplexMode>("duplexModes", DuplexModes);
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrinterFeedOrientation>("feedOrientations", FeedOrientations);
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintMultipageLayout>("multipageLayouts", MultipageLayouts);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintOrientation>("orientations", Orientations);
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintQuality>("qualities", Qualities);
            writer.WriteCollectionOfPrimitiveValues<int?>("rightMargins", RightMargins);
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.PrintScaling>("scalings", Scalings);
