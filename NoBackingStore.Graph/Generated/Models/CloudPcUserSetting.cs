...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CloudPcUserSetting : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.CloudPcUserSettingAssignment>? Assignments { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.CloudPcUserSettingAssignment> Assignments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.CloudPcRestorePointSetting? RestorePointSetting { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.CloudPcRestorePointSetting RestorePointSetting { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CloudPcUserSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CloudPcUserSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CloudPcUserSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CloudPcUserSettingAssignment>(global::NoBackingStore.Graph.Models.CloudPcUserSettingAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "restorePointSetting", n => { RestorePointSetting = n.GetObjectValue<global::NoBackingStore.Graph.Models.CloudPcRestorePointSetting>(global::NoBackingStore.Graph.Models.CloudPcRestorePointSetting.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CloudPcUserSettingAssignment>("assignments", Assignments);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.CloudPcRestorePointSetting>("restorePointSetting", RestorePointSetting);
        }
    }
}
