...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Organization : global::NoBackingStore.Graph.Models.DirectoryObject, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.OrganizationalBranding? Branding { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.OrganizationalBranding Branding { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.CertificateBasedAuthConfiguration>? CertificateBasedAuthConfiguration { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.MdmAuthority? MobileDeviceManagementAuthority { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.PartnerTenantType? PartnerTenantType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.PrivacyProfile? PrivacyProfile { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.PrivacyProfile PrivacyProfile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.VerifiedDomain>? VerifiedDomains { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.VerifiedDomain> VerifiedDomains { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Organization"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Organization"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Organization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Organization();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "branding", n => { Branding = n.GetObjectValue<global::NoBackingStore.Graph.Models.OrganizationalBranding>(global::NoBackingStore.Graph.Models.OrganizationalBranding.CreateFromDiscriminatorValue); } },
                { "businessPhones", n => { BusinessPhones = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "certificateBasedAuthConfiguration", n => { CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CertificateBasedAuthConfiguration>(global::NoBackingStore.Graph.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "mobileDeviceManagementAuthority", n => { MobileDeviceManagementAuthority = n.GetEnumValue<global::NoBackingStore.Graph.Models.MdmAuthority>(); } },
                { "onPremisesLastSyncDateTime", n => { OnPremisesLastSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "onPremisesSyncEnabled", n => { OnPremisesSyncEnabled = n.GetBoolValue(); } },
                { "partnerTenantType", n => { PartnerTenantType = n.GetEnumValue<global::NoBackingStore.Graph.Models.PartnerTenantType>(); } },
                { "postalCode", n => { PostalCode = n.GetStringValue(); } },
                { "preferredLanguage", n => { PreferredLanguage = n.GetStringValue(); } },
                { "privacyProfile", n => { PrivacyProfile = n.GetObjectValue<global::NoBackingStore.Graph.Models.PrivacyProfile>(global::NoBackingStore.Graph.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
                ...
                { "verifiedDomains", n => { VerifiedDomains = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.VerifiedDomain>(global::NoBackingStore.Graph.Models.VerifiedDomain.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.OrganizationalBranding>("branding", Branding);
            writer.WriteCollectionOfPrimitiveValues<string>("businessPhones", BusinessPhones);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CertificateBasedAuthConfiguration>("certificateBasedAuthConfiguration", CertificateBasedAuthConfiguration);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MdmAuthority>("mobileDeviceManagementAuthority", MobileDeviceManagementAuthority);
            writer.WriteDateTimeOffsetValue("onPremisesLastSyncDateTime", OnPremisesLastSyncDateTime);
            writer.WriteBoolValue("onPremisesSyncEnabled", OnPremisesSyncEnabled);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PartnerTenantType>("partnerTenantType", PartnerTenantType);
            writer.WriteStringValue("postalCode", PostalCode);
            writer.WriteStringValue("preferredLanguage", PreferredLanguage);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.PrivacyProfile>("privacyProfile", PrivacyProfile);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.VerifiedDomain>("verifiedDomains", VerifiedDomains);
        }
    }
}
