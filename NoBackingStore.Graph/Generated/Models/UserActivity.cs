...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UserActivity : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ActivityHistoryItem>? HistoryItems { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ActivityHistoryItem> HistoryItems { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.Status? Status { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.VisualInfo? VisualElements { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.VisualInfo VisualElements { get; set; }
#endif
        ...
        public static new global::NoBackingStore.Graph.Models.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UserActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "historyItems", n => { HistoryItems = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ActivityHistoryItem>(global::NoBackingStore.Graph.Models.ActivityHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.Status>(); } },
                { "userTimezone", n => { UserTimezone = n.GetStringValue(); } },
                { "visualElements", n => { VisualElements = n.GetObjectValue<global::NoBackingStore.Graph.Models.VisualInfo>(global::NoBackingStore.Graph.Models.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ActivityHistoryItem>("historyItems", HistoryItems);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Status>("status", Status);
            writer.WriteStringValue("userTimezone", UserTimezone);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.VisualInfo>("visualElements", VisualElements);
        }
    }
}
