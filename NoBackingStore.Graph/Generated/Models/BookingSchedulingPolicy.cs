...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.BookingsAvailabilityWindow>? CustomAvailabilities { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.BookingsAvailabilityWindow> CustomAvailabilities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.BookingsAvailability? GeneralAvailability { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.BookingsAvailability GeneralAvailability { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.BookingSchedulingPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.BookingSchedulingPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.BookingSchedulingPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.BookingSchedulingPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "customAvailabilities", n => { CustomAvailabilities = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingsAvailabilityWindow>(global::NoBackingStore.Graph.Models.BookingsAvailabilityWindow.CreateFromDiscriminatorValue)?.AsList(); } },
                { "generalAvailability", n => { GeneralAvailability = n.GetObjectValue<global::NoBackingStore.Graph.Models.BookingsAvailability>(global::NoBackingStore.Graph.Models.BookingsAvailability.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingsAvailabilityWindow>("customAvailabilities", CustomAvailabilities);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.BookingsAvailability>("generalAvailability", GeneralAvailability);
