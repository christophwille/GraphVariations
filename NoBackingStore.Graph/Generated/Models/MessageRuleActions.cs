...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? ForwardAsAttachmentTo { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> ForwardAsAttachmentTo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? ForwardTo { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> ForwardTo { get; set; }
#endif
        ...
        public global::NoBackingStore.Graph.Models.Importance? MarkImportance { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? RedirectTo { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> RedirectTo { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MessageRuleActions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MessageRuleActions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.MessageRuleActions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MessageRuleActions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "forwardAsAttachmentTo", n => { ForwardAsAttachmentTo = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "forwardTo", n => { ForwardTo = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "markAsRead", n => { MarkAsRead = n.GetBoolValue(); } },
                { "markImportance", n => { MarkImportance = n.GetEnumValue<global::NoBackingStore.Graph.Models.Importance>(); } },
                { "moveToFolder", n => { MoveToFolder = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "permanentDelete", n => { PermanentDelete = n.GetBoolValue(); } },
                { "redirectTo", n => { RedirectTo = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("forwardAsAttachmentTo", ForwardAsAttachmentTo);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("forwardTo", ForwardTo);
            writer.WriteBoolValue("markAsRead", MarkAsRead);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Importance>("markImportance", MarkImportance);
            writer.WriteStringValue("moveToFolder", MoveToFolder);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteBoolValue("permanentDelete", PermanentDelete);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("redirectTo", RedirectTo);
