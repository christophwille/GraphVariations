...
#nullable enable
        public global::NoBackingStore.Graph.Models.AutomaticRepliesMailTips? AutomaticReplies { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AutomaticRepliesMailTips AutomaticReplies { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.EmailAddress? EmailAddress { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.EmailAddress EmailAddress { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.MailTipsError? Error { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.MailTipsError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.RecipientScopeType? RecipientScope { get; set; }
        /// <summary>Recipients suggested based on previous contexts where they appear in the same message.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? RecipientSuggestions { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> RecipientSuggestions { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MailTips"/> and sets the default values.
        /// </summary>
        public MailTips()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MailTips"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.MailTips CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MailTips();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "automaticReplies", n => { AutomaticReplies = n.GetObjectValue<global::NoBackingStore.Graph.Models.AutomaticRepliesMailTips>(global::NoBackingStore.Graph.Models.AutomaticRepliesMailTips.CreateFromDiscriminatorValue); } },
                { "customMailTip", n => { CustomMailTip = n.GetStringValue(); } },
                { "deliveryRestricted", n => { DeliveryRestricted = n.GetBoolValue(); } },
                { "emailAddress", n => { EmailAddress = n.GetObjectValue<global::NoBackingStore.Graph.Models.EmailAddress>(global::NoBackingStore.Graph.Models.EmailAddress.CreateFromDiscriminatorValue); } },
                { "error", n => { Error = n.GetObjectValue<global::NoBackingStore.Graph.Models.MailTipsError>(global::NoBackingStore.Graph.Models.MailTipsError.CreateFromDiscriminatorValue); } },
                ...
                { "recipientScope", n => { RecipientScope = n.GetEnumValue<global::NoBackingStore.Graph.Models.RecipientScopeType>(); } },
                { "recipientSuggestions", n => { RecipientSuggestions = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AutomaticRepliesMailTips>("automaticReplies", AutomaticReplies);
            writer.WriteStringValue("customMailTip", CustomMailTip);
            writer.WriteBoolValue("deliveryRestricted", DeliveryRestricted);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.EmailAddress>("emailAddress", EmailAddress);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.MailTipsError>("error", Error);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.RecipientScopeType>("recipientScope", RecipientScope);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("recipientSuggestions", RecipientSuggestions);
