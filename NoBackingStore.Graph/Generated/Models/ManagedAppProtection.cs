...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class ManagedAppProtection : global::NoBackingStore.Graph.Models.ManagedAppPolicy, IParsable
    {
        /// <summary>Data storage locations where a user may store managed data.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.ManagedAppDataStorageLocation?>? AllowedDataStorageLocations { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.ManagedAppDataStorageLocation?> AllowedDataStorageLocations { get; set; }
#endif
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel? AllowedInboundDataTransferSources { get; set; }
        /// <summary>Represents the level to which the device&apos;s clipboard may be shared between apps</summary>
        public global::NoBackingStore.Graph.Models.ManagedAppClipboardSharingLevel? AllowedOutboundClipboardSharingLevel { get; set; }
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel? AllowedOutboundDataTransferDestinations { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.ManagedBrowserType? ManagedBrowser { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.ManagedAppPinCharacterSet? PinCharacterSet { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.ManagedAppProtection"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ManagedAppProtection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.ManagedAppProtection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::NoBackingStore.Graph.Models.ManagedAppProtection(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedDataStorageLocations", n => { AllowedDataStorageLocations = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.ManagedAppDataStorageLocation>()?.AsList(); } },
                { "allowedInboundDataTransferSources", n => { AllowedInboundDataTransferSources = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel>(); } },
                { "allowedOutboundClipboardSharingLevel", n => { AllowedOutboundClipboardSharingLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedAppClipboardSharingLevel>(); } },
                { "allowedOutboundDataTransferDestinations", n => { AllowedOutboundDataTransferDestinations = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel>(); } },
                ...
                { "managedBrowser", n => { ManagedBrowser = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedBrowserType>(); } },
                ...
                { "pinCharacterSet", n => { PinCharacterSet = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedAppPinCharacterSet>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.ManagedAppDataStorageLocation>("allowedDataStorageLocations", AllowedDataStorageLocations);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel>("allowedInboundDataTransferSources", AllowedInboundDataTransferSources);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedAppClipboardSharingLevel>("allowedOutboundClipboardSharingLevel", AllowedOutboundClipboardSharingLevel);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataTransferLevel>("allowedOutboundDataTransferDestinations", AllowedOutboundDataTransferDestinations);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedBrowserType>("managedBrowser", ManagedBrowser);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedAppPinCharacterSet>("pinCharacterSet", PinCharacterSet);
