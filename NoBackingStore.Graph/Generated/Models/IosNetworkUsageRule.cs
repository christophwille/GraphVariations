...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AppListItem>? ManagedApps { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AppListItem> ManagedApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.IosNetworkUsageRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.IosNetworkUsageRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.IosNetworkUsageRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.IosNetworkUsageRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "managedApps", n => { ManagedApps = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>(global::NoBackingStore.Graph.Models.AppListItem.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AppListItem>("managedApps", ManagedApps);
