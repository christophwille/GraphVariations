...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Fido2AuthenticationMethod : global::NoBackingStore.Graph.Models.AuthenticationMethod, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.AttestationLevel? AttestationLevel { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Fido2AuthenticationMethod"/> and sets the default values.
        /// </summary>
        ...
        public static new global::NoBackingStore.Graph.Models.Fido2AuthenticationMethod CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Fido2AuthenticationMethod();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attestationLevel", n => { AttestationLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.AttestationLevel>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AttestationLevel>("attestationLevel", AttestationLevel);
