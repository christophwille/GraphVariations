...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class BookingCustomer : global::NoBackingStore.Graph.Models.BookingCustomerBase, IParsable
    {
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.PhysicalAddress>? Addresses { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.PhysicalAddress> Addresses { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.BookingCustomer"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.BookingCustomer"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.BookingCustomer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.BookingCustomer();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "addresses", n => { Addresses = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.PhysicalAddress>(global::NoBackingStore.Graph.Models.PhysicalAddress.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.PhysicalAddress>("addresses", Addresses);
