...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Windows10TeamGeneralConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.MiracastChannel? MiracastChannel { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.WelcomeScreenMeetingInformation? WelcomeScreenMeetingInformation { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Windows10TeamGeneralConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Windows10TeamGeneralConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Windows10TeamGeneralConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Windows10TeamGeneralConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "miracastChannel", n => { MiracastChannel = n.GetEnumValue<global::NoBackingStore.Graph.Models.MiracastChannel>(); } },
                ...
                { "welcomeScreenMeetingInformation", n => { WelcomeScreenMeetingInformation = n.GetEnumValue<global::NoBackingStore.Graph.Models.WelcomeScreenMeetingInformation>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MiracastChannel>("miracastChannel", MiracastChannel);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WelcomeScreenMeetingInformation>("welcomeScreenMeetingInformation", WelcomeScreenMeetingInformation);
        }
    }
}
