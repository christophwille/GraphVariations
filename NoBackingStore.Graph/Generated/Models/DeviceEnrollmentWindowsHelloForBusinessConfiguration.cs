...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DeviceEnrollmentWindowsHelloForBusinessConfiguration : global::NoBackingStore.Graph.Models.DeviceEnrollmentConfiguration, IParsable
    {
        /// <summary>Possible values of a property</summary>
        public global::NoBackingStore.Graph.Models.Enablement? EnhancedBiometricsState { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage? PinLowercaseCharactersUsage { get; set; }
        ...
        /// <summary>Windows Hello for Business pin usage options</summary>
        public global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage? PinSpecialCharactersUsage { get; set; }
        /// <summary>Windows Hello for Business pin usage options</summary>
        public global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage? PinUppercaseCharactersUsage { get; set; }
        ...
        /// <summary>Possible values of a property</summary>
        public global::NoBackingStore.Graph.Models.Enablement? State { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "enhancedBiometricsState", n => { EnhancedBiometricsState = n.GetEnumValue<global::NoBackingStore.Graph.Models.Enablement>(); } },
                { "pinExpirationInDays", n => { PinExpirationInDays = n.GetIntValue(); } },
                { "pinLowercaseCharactersUsage", n => { PinLowercaseCharactersUsage = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "pinSpecialCharactersUsage", n => { PinSpecialCharactersUsage = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                { "pinUppercaseCharactersUsage", n => { PinUppercaseCharactersUsage = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "state", n => { State = n.GetEnumValue<global::NoBackingStore.Graph.Models.Enablement>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Enablement>("enhancedBiometricsState", EnhancedBiometricsState);
            writer.WriteIntValue("pinExpirationInDays", PinExpirationInDays);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>("pinLowercaseCharactersUsage", PinLowercaseCharactersUsage);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>("pinSpecialCharactersUsage", PinSpecialCharactersUsage);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsHelloForBusinessPinUsage>("pinUppercaseCharactersUsage", PinUppercaseCharactersUsage);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.Enablement>("state", State);
