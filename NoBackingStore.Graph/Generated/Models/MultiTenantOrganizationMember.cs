...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class MultiTenantOrganizationMember : global::NoBackingStore.Graph.Models.DirectoryObject, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberRole? Role { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberState? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberTransitionDetails? TransitionDetails { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberTransitionDetails TransitionDetails { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MultiTenantOrganizationMember"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MultiTenantOrganizationMember"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.MultiTenantOrganizationMember CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MultiTenantOrganizationMember();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "role", n => { Role = n.GetEnumValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberRole>(); } },
                { "state", n => { State = n.GetEnumValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberState>(); } },
                { "tenantId", n => { TenantId = n.GetStringValue(); } },
                { "transitionDetails", n => { TransitionDetails = n.GetObjectValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberTransitionDetails>(global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberTransitionDetails.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberRole>("role", Role);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberState>("state", State);
            writer.WriteStringValue("tenantId", TenantId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.MultiTenantOrganizationMemberTransitionDetails>("transitionDetails", TransitionDetails);
        }
    }
}
