...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.AppCredentialRestrictionType? RestrictionType { get; set; }
        /// <summary>The state property</summary>
        public global::NoBackingStore.Graph.Models.AppManagementRestrictionState? State { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.PasswordCredentialConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.PasswordCredentialConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.PasswordCredentialConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.PasswordCredentialConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "restrictionType", n => { RestrictionType = n.GetEnumValue<global::NoBackingStore.Graph.Models.AppCredentialRestrictionType>(); } },
                { "state", n => { State = n.GetEnumValue<global::NoBackingStore.Graph.Models.AppManagementRestrictionState>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AppCredentialRestrictionType>("restrictionType", RestrictionType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.AppManagementRestrictionState>("state", State);
