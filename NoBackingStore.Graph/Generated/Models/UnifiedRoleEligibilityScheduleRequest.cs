...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UnifiedRoleEligibilityScheduleRequest : global::NoBackingStore.Graph.Models.Request, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.UnifiedRoleScheduleRequestActions? Action { get; set; }
...
#nullable enable
        public global::NoBackingStore.Graph.Models.AppScope? AppScope { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AppScope AppScope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.DirectoryObject? DirectoryScope { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.DirectoryObject DirectoryScope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.UnifiedRoleDefinition? RoleDefinition { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UnifiedRoleDefinition RoleDefinition { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.UnifiedRoleEligibilitySchedule? TargetSchedule { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UnifiedRoleEligibilitySchedule TargetSchedule { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.TicketInfo? TicketInfo { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.TicketInfo TicketInfo { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::NoBackingStore.Graph.Models.UnifiedRoleScheduleRequestActions>(); } },
                { "appScope", n => { AppScope = n.GetObjectValue<global::NoBackingStore.Graph.Models.AppScope>(global::NoBackingStore.Graph.Models.AppScope.CreateFromDiscriminatorValue); } },
                { "appScopeId", n => { AppScopeId = n.GetStringValue(); } },
                { "directoryScope", n => { DirectoryScope = n.GetObjectValue<global::NoBackingStore.Graph.Models.DirectoryObject>(global::NoBackingStore.Graph.Models.DirectoryObject.CreateFromDiscriminatorValue); } },
                ...
                { "roleDefinition", n => { RoleDefinition = n.GetObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition>(global::NoBackingStore.Graph.Models.UnifiedRoleDefinition.CreateFromDiscriminatorValue); } },
                ...
                { "targetSchedule", n => { TargetSchedule = n.GetObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleEligibilitySchedule>(global::NoBackingStore.Graph.Models.UnifiedRoleEligibilitySchedule.CreateFromDiscriminatorValue); } },
                { "targetScheduleId", n => { TargetScheduleId = n.GetStringValue(); } },
                { "ticketInfo", n => { TicketInfo = n.GetObjectValue<global::NoBackingStore.Graph.Models.TicketInfo>(global::NoBackingStore.Graph.Models.TicketInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.UnifiedRoleScheduleRequestActions>("action", Action);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AppScope>("appScope", AppScope);
            writer.WriteStringValue("appScopeId", AppScopeId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.DirectoryObject>("directoryScope", DirectoryScope);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleDefinition>("roleDefinition", RoleDefinition);
            writer.WriteStringValue("roleDefinitionId", RoleDefinitionId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.RequestSchedule>("scheduleInfo", ScheduleInfo);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleEligibilitySchedule>("targetSchedule", TargetSchedule);
            writer.WriteStringValue("targetScheduleId", TargetScheduleId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.TicketInfo>("ticketInfo", TicketInfo);
        }
    }
}
