...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class IosUpdateConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DayOfWeekObject?>? ScheduledInstallDays { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DayOfWeekObject?> ScheduledInstallDays { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.IosUpdateConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.IosUpdateConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.IosUpdateConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.IosUpdateConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "scheduledInstallDays", n => { ScheduledInstallDays = n.GetCollectionOfEnumValues<global::NoBackingStore.Graph.Models.DayOfWeekObject>()?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::NoBackingStore.Graph.Models.DayOfWeekObject>("scheduledInstallDays", ScheduledInstallDays);
