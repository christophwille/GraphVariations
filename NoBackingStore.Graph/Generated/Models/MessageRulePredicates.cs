...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? FromAddresses { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> FromAddresses { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.MessageActionFlag? MessageActionFlag { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.Recipient>? SentToAddresses { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.Recipient> SentToAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.SizeRange? WithinSizeRange { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.SizeRange WithinSizeRange { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.MessageRulePredicates"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.MessageRulePredicates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.MessageRulePredicates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.MessageRulePredicates();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fromAddresses", n => { FromAddresses = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "messageActionFlag", n => { MessageActionFlag = n.GetEnumValue<global::NoBackingStore.Graph.Models.MessageActionFlag>(); } },
                ...
                { "sentToAddresses", n => { SentToAddresses = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>(global::NoBackingStore.Graph.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "withinSizeRange", n => { WithinSizeRange = n.GetObjectValue<global::NoBackingStore.Graph.Models.SizeRange>(global::NoBackingStore.Graph.Models.SizeRange.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("fromAddresses", FromAddresses);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MessageActionFlag>("messageActionFlag", MessageActionFlag);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.Recipient>("sentToAddresses", SentToAddresses);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.SizeRange>("withinSizeRange", WithinSizeRange);
