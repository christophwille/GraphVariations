...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Device : global::NoBackingStore.Graph.Models.DirectoryObject, IParsable
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AlternativeSecurityId>? AlternativeSecurityIds { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AlternativeSecurityId> AlternativeSecurityIds { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DirectoryObject>? RegisteredOwners { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DirectoryObject> RegisteredOwners { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DirectoryObject>? RegisteredUsers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DirectoryObject> RegisteredUsers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Device"/> and sets the default values.
        /// </summary>
        public Device() : base()
        {
        ...
        public static new global::NoBackingStore.Graph.Models.Device CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Device();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "alternativeSecurityIds", n => { AlternativeSecurityIds = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AlternativeSecurityId>(global::NoBackingStore.Graph.Models.AlternativeSecurityId.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "registeredOwners", n => { RegisteredOwners = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>(global::NoBackingStore.Graph.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "registeredUsers", n => { RegisteredUsers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>(global::NoBackingStore.Graph.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AlternativeSecurityId>("alternativeSecurityIds", AlternativeSecurityIds);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>("registeredOwners", RegisteredOwners);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>("registeredUsers", RegisteredUsers);
