...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class VppToken : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.VppTokenSyncStatus? LastSyncStatus { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.VppTokenState? State { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.VppTokenAccountType? VppTokenAccountType { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.VppToken"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.VppToken CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.VppToken();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "lastSyncStatus", n => { LastSyncStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.VppTokenSyncStatus>(); } },
                { "organizationName", n => { OrganizationName = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<global::NoBackingStore.Graph.Models.VppTokenState>(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "vppTokenAccountType", n => { VppTokenAccountType = n.GetEnumValue<global::NoBackingStore.Graph.Models.VppTokenAccountType>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.VppTokenSyncStatus>("lastSyncStatus", LastSyncStatus);
            writer.WriteStringValue("organizationName", OrganizationName);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.VppTokenState>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.VppTokenAccountType>("vppTokenAccountType", VppTokenAccountType);
        }
    }
}
