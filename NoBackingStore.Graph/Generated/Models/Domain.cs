...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Domain : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DirectoryObject>? DomainNameReferences { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DirectoryObject> DomainNameReferences { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.InternalDomainFederation>? FederationConfiguration { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.InternalDomainFederation> FederationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Domain? RootDomain { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Domain RootDomain { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DomainDnsRecord>? ServiceConfigurationRecords { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DomainDnsRecord> ServiceConfigurationRecords { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.DomainState? State { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.DomainState State { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DomainDnsRecord>? VerificationDnsRecords { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DomainDnsRecord> VerificationDnsRecords { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Domain"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Domain CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Domain();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "domainNameReferences", n => { DomainNameReferences = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>(global::NoBackingStore.Graph.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "federationConfiguration", n => { FederationConfiguration = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.InternalDomainFederation>(global::NoBackingStore.Graph.Models.InternalDomainFederation.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rootDomain", n => { RootDomain = n.GetObjectValue<global::NoBackingStore.Graph.Models.Domain>(global::NoBackingStore.Graph.Models.Domain.CreateFromDiscriminatorValue); } },
                { "serviceConfigurationRecords", n => { ServiceConfigurationRecords = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DomainDnsRecord>(global::NoBackingStore.Graph.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
                { "state", n => { State = n.GetObjectValue<global::NoBackingStore.Graph.Models.DomainState>(global::NoBackingStore.Graph.Models.DomainState.CreateFromDiscriminatorValue); } },
                { "supportedServices", n => { SupportedServices = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "verificationDnsRecords", n => { VerificationDnsRecords = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DomainDnsRecord>(global::NoBackingStore.Graph.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DirectoryObject>("domainNameReferences", DomainNameReferences);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.InternalDomainFederation>("federationConfiguration", FederationConfiguration);
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Domain>("rootDomain", RootDomain);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DomainDnsRecord>("serviceConfigurationRecords", ServiceConfigurationRecords);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.DomainState>("state", State);
            writer.WriteCollectionOfPrimitiveValues<string>("supportedServices", SupportedServices);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DomainDnsRecord>("verificationDnsRecords", VerificationDnsRecords);
        }
    }
}
