...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Windows81GeneralConfiguration : global::NoBackingStore.Graph.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.InternetSiteSecurityLevel? BrowserInternetSecurityLevel { get; set; }
        /// <summary>Possible values for site security level.</summary>
        public global::NoBackingStore.Graph.Models.SiteSecurityLevel? BrowserIntranetSecurityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>Possible values for site security level.</summary>
        public global::NoBackingStore.Graph.Models.SiteSecurityLevel? BrowserTrustedSitesSecurityLevel { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.WindowsUserAccountControlSettings? UserAccountControlSettings { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.Windows81GeneralConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Windows81GeneralConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Windows81GeneralConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Windows81GeneralConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "browserInternetSecurityLevel", n => { BrowserInternetSecurityLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.InternetSiteSecurityLevel>(); } },
                { "browserIntranetSecurityLevel", n => { BrowserIntranetSecurityLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.SiteSecurityLevel>(); } },
                ...
                { "browserTrustedSitesSecurityLevel", n => { BrowserTrustedSitesSecurityLevel = n.GetEnumValue<global::NoBackingStore.Graph.Models.SiteSecurityLevel>(); } },
                ...
                { "userAccountControlSettings", n => { UserAccountControlSettings = n.GetEnumValue<global::NoBackingStore.Graph.Models.WindowsUserAccountControlSettings>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.InternetSiteSecurityLevel>("browserInternetSecurityLevel", BrowserInternetSecurityLevel);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SiteSecurityLevel>("browserIntranetSecurityLevel", BrowserIntranetSecurityLevel);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SiteSecurityLevel>("browserTrustedSitesSecurityLevel", BrowserTrustedSitesSecurityLevel);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.WindowsUserAccountControlSettings>("userAccountControlSettings", UserAccountControlSettings);
