...
namespace NoBackingStore.Graph.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.BackupServiceConsumer? BackupServiceConsumer { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.DisableReason? DisableReason { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.BackupServiceStatus? Status { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.ServiceStatus"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.ServiceStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.ServiceStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.ServiceStatus();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "backupServiceConsumer", n => { BackupServiceConsumer = n.GetEnumValue<global::NoBackingStore.Graph.Models.BackupServiceConsumer>(); } },
                { "disableReason", n => { DisableReason = n.GetEnumValue<global::NoBackingStore.Graph.Models.DisableReason>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.BackupServiceStatus>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.BackupServiceConsumer>("backupServiceConsumer", BackupServiceConsumer);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DisableReason>("disableReason", DisableReason);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.BackupServiceStatus>("status", Status);
