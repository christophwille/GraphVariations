...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class RelyingPartyDetailedSummary : global::NoBackingStore.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.MigrationStatus? MigrationStatus { get; set; }
        /// <summary>Specifies all the validations checks done on applications config details.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.KeyValuePair>? MigrationValidationDetails { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.KeyValuePair> MigrationValidationDetails { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.RelyingPartyDetailedSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.RelyingPartyDetailedSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.RelyingPartyDetailedSummary();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "migrationStatus", n => { MigrationStatus = n.GetEnumValue<global::NoBackingStore.Graph.Models.MigrationStatus>(); } },
                { "migrationValidationDetails", n => { MigrationValidationDetails = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValuePair>(global::NoBackingStore.Graph.Models.KeyValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.MigrationStatus>("migrationStatus", MigrationStatus);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValuePair>("migrationValidationDetails", MigrationValidationDetails);
