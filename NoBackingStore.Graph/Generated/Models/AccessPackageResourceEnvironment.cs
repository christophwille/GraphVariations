...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AccessPackageResourceEnvironment : global::NoBackingStore.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Connection information of an environment used to connect to a resource.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.ConnectionInfo? ConnectionInfo { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.ConnectionInfo ConnectionInfo { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AccessPackageResourceEnvironment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AccessPackageResourceEnvironment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AccessPackageResourceEnvironment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "connectionInfo", n => { ConnectionInfo = n.GetObjectValue<global::NoBackingStore.Graph.Models.ConnectionInfo>(global::NoBackingStore.Graph.Models.ConnectionInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.ConnectionInfo>("connectionInfo", ConnectionInfo);
