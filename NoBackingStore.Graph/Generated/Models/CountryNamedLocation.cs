...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class CountryNamedLocation : global::NoBackingStore.Graph.Models.NamedLocation, IParsable
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CountryLookupMethodType? CountryLookupMethod { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CountryNamedLocation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.CountryNamedLocation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CountryNamedLocation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "countryLookupMethod", n => { CountryLookupMethod = n.GetEnumValue<global::NoBackingStore.Graph.Models.CountryLookupMethodType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CountryLookupMethodType>("countryLookupMethod", CountryLookupMethod);
