...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class AccessReviewScheduleDefinition : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessReviewNotificationRecipientItem>? AdditionalNotificationRecipients { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessReviewNotificationRecipientItem> AdditionalNotificationRecipients { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>? FallbackReviewers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope> FallbackReviewers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessReviewScope? InstanceEnumerationScope { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessReviewScope InstanceEnumerationScope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessReviewInstance>? Instances { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessReviewInstance> Instances { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>? Reviewers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope> Reviewers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessReviewScope? Scope { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessReviewScope Scope { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AccessReviewScheduleSettings? Settings { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AccessReviewScheduleSettings Settings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.AccessReviewStageSettings>? StageSettings { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.AccessReviewStageSettings> StageSettings { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.AccessReviewScheduleDefinition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.AccessReviewScheduleDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.AccessReviewScheduleDefinition();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "additionalNotificationRecipients", n => { AdditionalNotificationRecipients = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewNotificationRecipientItem>(global::NoBackingStore.Graph.Models.AccessReviewNotificationRecipientItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "fallbackReviewers", n => { FallbackReviewers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>(global::NoBackingStore.Graph.Models.AccessReviewReviewerScope.CreateFromDiscriminatorValue)?.AsList(); } },
                { "instanceEnumerationScope", n => { InstanceEnumerationScope = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScope>(global::NoBackingStore.Graph.Models.AccessReviewScope.CreateFromDiscriminatorValue); } },
                { "instances", n => { Instances = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewInstance>(global::NoBackingStore.Graph.Models.AccessReviewInstance.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "reviewers", n => { Reviewers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>(global::NoBackingStore.Graph.Models.AccessReviewReviewerScope.CreateFromDiscriminatorValue)?.AsList(); } },
                { "scope", n => { Scope = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScope>(global::NoBackingStore.Graph.Models.AccessReviewScope.CreateFromDiscriminatorValue); } },
                { "settings", n => { Settings = n.GetObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScheduleSettings>(global::NoBackingStore.Graph.Models.AccessReviewScheduleSettings.CreateFromDiscriminatorValue); } },
                { "stageSettings", n => { StageSettings = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewStageSettings>(global::NoBackingStore.Graph.Models.AccessReviewStageSettings.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewNotificationRecipientItem>("additionalNotificationRecipients", AdditionalNotificationRecipients);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>("fallbackReviewers", FallbackReviewers);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScope>("instanceEnumerationScope", InstanceEnumerationScope);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewInstance>("instances", Instances);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewReviewerScope>("reviewers", Reviewers);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScope>("scope", Scope);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AccessReviewScheduleSettings>("settings", Settings);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.AccessReviewStageSettings>("stageSettings", StageSettings);
