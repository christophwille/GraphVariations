...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.EmailRole? EmailRole { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.LogonType? LogonType { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.UserAccountSecurityType? UserAccountType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.UserSecurityState"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UserSecurityState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.UserSecurityState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UserSecurityState();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "emailRole", n => { EmailRole = n.GetEnumValue<global::NoBackingStore.Graph.Models.EmailRole>(); } },
                ...
                { "logonType", n => { LogonType = n.GetEnumValue<global::NoBackingStore.Graph.Models.LogonType>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "onPremisesSecurityIdentifier", n => { OnPremisesSecurityIdentifier = n.GetStringValue(); } },
                { "riskScore", n => { RiskScore = n.GetStringValue(); } },
                { "userAccountType", n => { UserAccountType = n.GetEnumValue<global::NoBackingStore.Graph.Models.UserAccountSecurityType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.EmailRole>("emailRole", EmailRole);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.LogonType>("logonType", LogonType);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteStringValue("onPremisesSecurityIdentifier", OnPremisesSecurityIdentifier);
            writer.WriteStringValue("riskScore", RiskScore);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.UserAccountSecurityType>("userAccountType", UserAccountType);
