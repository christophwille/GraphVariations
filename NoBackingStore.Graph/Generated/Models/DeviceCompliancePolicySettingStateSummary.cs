...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DeviceCompliancePolicySettingStateSummary : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#nullable enable
        public List<global::NoBackingStore.Graph.Models.DeviceComplianceSettingState>? DeviceComplianceSettingStates { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.DeviceComplianceSettingState> DeviceComplianceSettingStates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DeviceCompliancePolicySettingStateSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DeviceCompliancePolicySettingStateSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DeviceCompliancePolicySettingStateSummary();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "deviceComplianceSettingStates", n => { DeviceComplianceSettingStates = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DeviceComplianceSettingState>(global::NoBackingStore.Graph.Models.DeviceComplianceSettingState.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.DeviceComplianceSettingState>("deviceComplianceSettingStates", DeviceComplianceSettingStates);
