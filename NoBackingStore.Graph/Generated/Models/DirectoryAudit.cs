...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DirectoryAudit : global::NoBackingStore.Graph.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.KeyValue>? AdditionalDetails { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.KeyValue> AdditionalDetails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.AuditActivityInitiator? InitiatedBy { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.AuditActivityInitiator InitiatedBy { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.OperationResult? Result { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.TargetResource>? TargetResources { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.TargetResource> TargetResources { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DirectoryAudit"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DirectoryAudit CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DirectoryAudit();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "additionalDetails", n => { AdditionalDetails = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValue>(global::NoBackingStore.Graph.Models.KeyValue.CreateFromDiscriminatorValue)?.AsList(); } },
                { "category", n => { Category = n.GetStringValue(); } },
                { "correlationId", n => { CorrelationId = n.GetStringValue(); } },
                { "initiatedBy", n => { InitiatedBy = n.GetObjectValue<global::NoBackingStore.Graph.Models.AuditActivityInitiator>(global::NoBackingStore.Graph.Models.AuditActivityInitiator.CreateFromDiscriminatorValue); } },
                { "loggedByService", n => { LoggedByService = n.GetStringValue(); } },
                { "operationType", n => { OperationType = n.GetStringValue(); } },
                { "result", n => { Result = n.GetEnumValue<global::NoBackingStore.Graph.Models.OperationResult>(); } },
                { "resultReason", n => { ResultReason = n.GetStringValue(); } },
                { "targetResources", n => { TargetResources = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.TargetResource>(global::NoBackingStore.Graph.Models.TargetResource.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValue>("additionalDetails", AdditionalDetails);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.AuditActivityInitiator>("initiatedBy", InitiatedBy);
            writer.WriteStringValue("loggedByService", LoggedByService);
            writer.WriteStringValue("operationType", OperationType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.OperationResult>("result", Result);
            writer.WriteStringValue("resultReason", ResultReason);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.TargetResource>("targetResources", TargetResources);
        }
    }
}
