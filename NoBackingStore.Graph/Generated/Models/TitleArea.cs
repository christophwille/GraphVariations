...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.TitleAreaLayoutType? Layout { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.ServerProcessedContent? ServerProcessedContent { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.ServerProcessedContent ServerProcessedContent { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.TitleAreaTextAlignmentType? TextAlignment { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.TitleArea"/> and sets the default values.
        /// </summary>
        public TitleArea()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.TitleArea"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.TitleArea CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.TitleArea();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "layout", n => { Layout = n.GetEnumValue<global::NoBackingStore.Graph.Models.TitleAreaLayoutType>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "serverProcessedContent", n => { ServerProcessedContent = n.GetObjectValue<global::NoBackingStore.Graph.Models.ServerProcessedContent>(global::NoBackingStore.Graph.Models.ServerProcessedContent.CreateFromDiscriminatorValue); } },
                ...
                { "textAlignment", n => { TextAlignment = n.GetEnumValue<global::NoBackingStore.Graph.Models.TitleAreaTextAlignmentType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.TitleAreaLayoutType>("layout", Layout);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.ServerProcessedContent>("serverProcessedContent", ServerProcessedContent);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.TitleAreaTextAlignmentType>("textAlignment", TextAlignment);
