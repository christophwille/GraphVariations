...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class Payload : global::NoBackingStore.Graph.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.PayloadBrand? Brand { get; set; }
        /// <summary>The complexity of a payload. Possible values are: unknown, low, medium, high, unknownFutureValue.</summary>
        public global::NoBackingStore.Graph.Models.PayloadComplexity? Complexity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.PayloadDetail? Detail { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.PayloadDetail Detail { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.PayloadIndustry? Industry { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.PayloadDeliveryPlatform? Platform { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.SimulationAttackType? SimulationAttackType { get; set; }
        /// <summary>The source property</summary>
        public global::NoBackingStore.Graph.Models.SimulationContentSource? Source { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.SimulationContentStatus? Status { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.SimulationAttackTechnique? Technique { get; set; }
        ...
        public global::NoBackingStore.Graph.Models.PayloadTheme? Theme { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.Payload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.Payload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.Payload();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "brand", n => { Brand = n.GetEnumValue<global::NoBackingStore.Graph.Models.PayloadBrand>(); } },
                { "complexity", n => { Complexity = n.GetEnumValue<global::NoBackingStore.Graph.Models.PayloadComplexity>(); } },
                ...
                { "detail", n => { Detail = n.GetObjectValue<global::NoBackingStore.Graph.Models.PayloadDetail>(global::NoBackingStore.Graph.Models.PayloadDetail.CreateFromDiscriminatorValue); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "industry", n => { Industry = n.GetEnumValue<global::NoBackingStore.Graph.Models.PayloadIndustry>(); } },
                ...
                { "platform", n => { Platform = n.GetEnumValue<global::NoBackingStore.Graph.Models.PayloadDeliveryPlatform>(); } },
                { "predictedCompromiseRate", n => { PredictedCompromiseRate = n.GetDoubleValue(); } },
                { "simulationAttackType", n => { SimulationAttackType = n.GetEnumValue<global::NoBackingStore.Graph.Models.SimulationAttackType>(); } },
                { "source", n => { Source = n.GetEnumValue<global::NoBackingStore.Graph.Models.SimulationContentSource>(); } },
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.SimulationContentStatus>(); } },
                { "technique", n => { Technique = n.GetEnumValue<global::NoBackingStore.Graph.Models.SimulationAttackTechnique>(); } },
                { "theme", n => { Theme = n.GetEnumValue<global::NoBackingStore.Graph.Models.PayloadTheme>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PayloadBrand>("brand", Brand);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PayloadComplexity>("complexity", Complexity);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.EmailIdentity>("createdBy", CreatedBy);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.PayloadDetail>("detail", Detail);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PayloadIndustry>("industry", Industry);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PayloadDeliveryPlatform>("platform", Platform);
            writer.WriteDoubleValue("predictedCompromiseRate", PredictedCompromiseRate);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SimulationAttackType>("simulationAttackType", SimulationAttackType);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SimulationContentSource>("source", Source);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SimulationContentStatus>("status", Status);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.SimulationAttackTechnique>("technique", Technique);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.PayloadTheme>("theme", Theme);
        }
    }
}
