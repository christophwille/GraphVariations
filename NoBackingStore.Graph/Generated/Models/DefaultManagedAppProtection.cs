...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DefaultManagedAppProtection : global::NoBackingStore.Graph.Models.ManagedAppProtection, IParsable
    {
        /// <summary>Represents the level to which app data is encrypted for managed apps</summary>
        public global::NoBackingStore.Graph.Models.ManagedAppDataEncryptionType? AppDataEncryptionType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.KeyValuePair>? CustomSettings { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.KeyValuePair> CustomSettings { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.DefaultManagedAppProtection"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DefaultManagedAppProtection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DefaultManagedAppProtection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DefaultManagedAppProtection();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "appDataEncryptionType", n => { AppDataEncryptionType = n.GetEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataEncryptionType>(); } },
                ...
                { "customSettings", n => { CustomSettings = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValuePair>(global::NoBackingStore.Graph.Models.KeyValuePair.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.ManagedAppDataEncryptionType>("appDataEncryptionType", AppDataEncryptionType);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.ManagedMobileApp>("apps", Apps);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.KeyValuePair>("customSettings", CustomSettings);
