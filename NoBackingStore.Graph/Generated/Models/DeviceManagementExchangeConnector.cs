...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class DeviceManagementExchangeConnector : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorType? ExchangeConnectorType { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnector"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnector CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnector();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "exchangeConnectorType", n => { ExchangeConnectorType = n.GetEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorType>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorType>("exchangeConnectorType", ExchangeConnectorType);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.DeviceManagementExchangeConnectorStatus>("status", Status);
