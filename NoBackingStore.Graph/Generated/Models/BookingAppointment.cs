...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class BookingAppointment : global::NoBackingStore.Graph.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.BookingCustomerInformationBase>? Customers { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.BookingCustomerInformationBase> Customers { get; set; }
#endif
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.BookingPriceType? PriceType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.BookingReminder>? Reminders { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.BookingReminder> Reminders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::NoBackingStore.Graph.Models.Location? ServiceLocation { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.Location ServiceLocation { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.BookingAppointment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.BookingAppointment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.BookingAppointment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "customers", n => { Customers = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingCustomerInformationBase>(global::NoBackingStore.Graph.Models.BookingCustomerInformationBase.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "priceType", n => { PriceType = n.GetEnumValue<global::NoBackingStore.Graph.Models.BookingPriceType>(); } },
                { "reminders", n => { Reminders = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingReminder>(global::NoBackingStore.Graph.Models.BookingReminder.CreateFromDiscriminatorValue)?.AsList(); } },
                { "selfServiceAppointmentId", n => { SelfServiceAppointmentId = n.GetStringValue(); } },
                { "serviceId", n => { ServiceId = n.GetStringValue(); } },
                { "serviceLocation", n => { ServiceLocation = n.GetObjectValue<global::NoBackingStore.Graph.Models.Location>(global::NoBackingStore.Graph.Models.Location.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingCustomerInformationBase>("customers", Customers);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.BookingPriceType>("priceType", PriceType);
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.BookingReminder>("reminders", Reminders);
            writer.WriteStringValue("selfServiceAppointmentId", SelfServiceAppointmentId);
            writer.WriteStringValue("serviceId", ServiceId);
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.Location>("serviceLocation", ServiceLocation);
