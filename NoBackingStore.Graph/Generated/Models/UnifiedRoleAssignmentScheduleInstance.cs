...
namespace NoBackingStore.Graph.Models
{
    ...
    public partial class UnifiedRoleAssignmentScheduleInstance : global::NoBackingStore.Graph.Models.UnifiedRoleScheduleInstanceBase, IParsable
...
#nullable enable
        public global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleInstance? ActivatedUsing { get; set; }
#nullable restore
#else
        public global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleInstance ActivatedUsing { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.UnifiedRoleAssignmentScheduleInstance"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::NoBackingStore.Graph.Models.UnifiedRoleAssignmentScheduleInstance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.UnifiedRoleAssignmentScheduleInstance();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "activatedUsing", n => { ActivatedUsing = n.GetObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleInstance>(global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleInstance.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::NoBackingStore.Graph.Models.UnifiedRoleEligibilityScheduleInstance>("activatedUsing", ActivatedUsing);
