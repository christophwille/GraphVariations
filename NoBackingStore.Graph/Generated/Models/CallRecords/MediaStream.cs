...
namespace NoBackingStore.Graph.Models.CallRecords
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.AudioCodec? AudioCodec { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.MediaStreamDirection? StreamDirection { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.VideoCodec? VideoCodec { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.CallRecords.MediaStream"/> and sets the default values.
        /// </summary>
        public MediaStream()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CallRecords.MediaStream"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.CallRecords.MediaStream CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CallRecords.MediaStream();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "audioCodec", n => { AudioCodec = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.AudioCodec>(); } },
                ...
                { "streamDirection", n => { StreamDirection = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.MediaStreamDirection>(); } },
                { "streamId", n => { StreamId = n.GetStringValue(); } },
                { "videoCodec", n => { VideoCodec = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.VideoCodec>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.AudioCodec>("audioCodec", AudioCodec);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.MediaStreamDirection>("streamDirection", StreamDirection);
            writer.WriteStringValue("streamId", StreamId);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.VideoCodec>("videoCodec", VideoCodec);
