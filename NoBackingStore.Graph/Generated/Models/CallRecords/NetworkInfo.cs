...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.NetworkConnectionType? ConnectionType { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.NetworkTransportProtocol? NetworkTransportProtocol { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::NoBackingStore.Graph.Models.CallRecords.TraceRouteHop>? TraceRouteHops { get; set; }
#nullable restore
#else
        public List<global::NoBackingStore.Graph.Models.CallRecords.TraceRouteHop> TraceRouteHops { get; set; }
#endif
        /// <summary>The wifiBand property</summary>
        public global::NoBackingStore.Graph.Models.CallRecords.WifiBand? WifiBand { get; set; }
...
#nullable restore
        ...
        public global::NoBackingStore.Graph.Models.CallRecords.WifiRadioType? WifiRadioType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Models.CallRecords.NetworkInfo"/> and sets the default values.
        /// </summary>
        public NetworkInfo()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Models.CallRecords.NetworkInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::NoBackingStore.Graph.Models.CallRecords.NetworkInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::NoBackingStore.Graph.Models.CallRecords.NetworkInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "connectionType", n => { ConnectionType = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.NetworkConnectionType>(); } },
                ...
                { "networkTransportProtocol", n => { NetworkTransportProtocol = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.NetworkTransportProtocol>(); } },
                ...
                { "traceRouteHops", n => { TraceRouteHops = n.GetCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CallRecords.TraceRouteHop>(global::NoBackingStore.Graph.Models.CallRecords.TraceRouteHop.CreateFromDiscriminatorValue)?.AsList(); } },
                { "wifiBand", n => { WifiBand = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.WifiBand>(); } },
                ...
                { "wifiRadioType", n => { WifiRadioType = n.GetEnumValue<global::NoBackingStore.Graph.Models.CallRecords.WifiRadioType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.NetworkConnectionType>("connectionType", ConnectionType);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.NetworkTransportProtocol>("networkTransportProtocol", NetworkTransportProtocol);
            ...
            writer.WriteCollectionOfObjectValues<global::NoBackingStore.Graph.Models.CallRecords.TraceRouteHop>("traceRouteHops", TraceRouteHops);
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.WifiBand>("wifiBand", WifiBand);
            ...
            writer.WriteEnumValue<global::NoBackingStore.Graph.Models.CallRecords.WifiRadioType>("wifiRadioType", WifiRadioType);
