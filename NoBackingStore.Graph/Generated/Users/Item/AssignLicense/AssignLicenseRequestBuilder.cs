...
using System;
namespace NoBackingStore.Graph.Users.Item.AssignLicense
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicenseRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::NoBackingStore.Graph.Models.User?> PostAsync(global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::NoBackingStore.Graph.Models.User> PostAsync(global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicensePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicenseRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicenseRequestBuilder WithUrl(string rawUrl)
        {
            return new global::NoBackingStore.Graph.Users.Item.AssignLicense.AssignLicenseRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
