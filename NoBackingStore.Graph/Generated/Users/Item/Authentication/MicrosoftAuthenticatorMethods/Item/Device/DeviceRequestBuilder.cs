...
using System;
namespace NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::NoBackingStore.Graph.Models.Device?> GetAsync(Action<RequestConfiguration<global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder.DeviceRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::NoBackingStore.Graph.Models.Device> GetAsync(Action<RequestConfiguration<global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder.DeviceRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder.DeviceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder.DeviceRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// The registered device on which Microsoft Authenticator resides. This property is null if the device isn&apos;t registered for passwordless Phone Sign-In.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DeviceRequestBuilderGetRequestConfiguration : RequestConfiguration<global::NoBackingStore.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.DeviceRequestBuilder.DeviceRequestBuilderGetQueryParameters>
        {
        }
    }
}
