...
namespace NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.CloneRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.ClonePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.ClonePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.ClonePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.ClonePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.CloneRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.CloneRequestBuilder WithUrl(string rawUrl)
        {
            return new global::NoBackingStore.Graph.Users.Item.JoinedTeams.Item.Clone.CloneRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
